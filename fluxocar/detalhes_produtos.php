...
<table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="100%">
  <tr>
    ...
    <td colspan="4" rowspan="5">
      <iframe name="I1" width="420" height="290" src="branco.htm" border="0" frameborder="0" scrolling="no">
  ...
  <tr>
    ...
    <td><span class="style1"><span class="style8">Sola</span></span><br>
          <span class="style1"><? echo $linha[4]; ?></span>
    </td>
  ...
  <tr>
    ...
    <td colspan="2">      <span class="style5">
      <? if($linha[11]=="Sim"){
printf("Preço de Oferta<br> R$ $linha[12]");
$linha[11]="Não";
}
?>
    </span></td>
