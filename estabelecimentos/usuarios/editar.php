...
<table width="100%" border="0" cellspacing="4">
    <tr>
      ...
      <td><strong>N&ordm; do cart&atilde;o <font color="#0000FF"><? echo $codigo; ?></font>
    ...
    <tr>
      ...
      <td>Status de envio do cart&atilde;o </td>
      <td><strong><font color="#0000FF"><? echo $status_de_envio; ?>
            <input name="status_de_envio" type="hidden" id="cidade_estab_pertence" value="<? echo $status_de_envio; ?>">
      </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr> 
      <td>Nome</td>
      <td><input name="nome" class='class02' type="text" id="nome2" value="<? echo $nome; ?>" size="50" maxlength="50"></td>
      <td>Fun&ccedil;&atilde;o</td>
      <td><strong>
        <input name="funcao" class='class02' type="text" id="funcao" value="<? echo $funcao; ?>">
      </strong>        </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td width="13%">Data Nasc </td>
      <td width="34%"><input name="data_nasc" class='class02' type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10"></td>
      <td width="21%">Sexo</td>
      <td width="31%"><select name="sexo" class='class02' id="sexo">
...
?>
      ...
      <td>CPF</td>
      <td><input name="cpf" class='class02' type="text" id="cpf" value="<? echo $cpf; ?>" size="18" maxlength="14"> 
      </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>RG</td>
      <td><input name="rg" class='class02' type="text" id="rg" value="<? echo $rg; ?>" size="25" maxlength="25"> 
        &Oacute;rg&atilde;o 
        <input name="orgao" class='class02' type="text" id="orgao" value="<? echo $orgao; ?>" size="15" maxlength="14"></td>
      <td>Emiss&atilde;o</td>
      <td><input name="emissao" class='class02' type="text" id="cpf4" value="<? echo $emissao; ?>" size="15" maxlength="10"> 
        dd/mm/aaaa </td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Pai</td>
      <td><input name="pai" class='class02' type="text" id="pai" value="<? echo $pai; ?>" size="50" maxlength="50"></td>
      <td>M&atilde;e</td>
      <td><input name="mae" class='class02' type="text" id="endereco3" value="<? echo $mae; ?>" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Endere&ccedil;o</td>
      <td><input name="endereco" class='class02' type="text" id="endereco" value="<? echo $endereco; ?>" size="50" maxlength="50"> 
      </td>
      <td>N&uacute;mero</td>
      <td><input name="numero" class='class02' type="text" id="numero2" value="<? echo $numero; ?>" size="10" maxlength="10"> 
      </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td><p>Bairro</p></td>
      <td><input name="bairro" class='class02' type="text" id="bairro" value="<? echo $bairro; ?>" size="50" maxlength="50"> 
      </td>
      <td>Complemento</td>
      <td><input name="complemento" class='class02' type="text" id="endereco4" value="<? echo $complemento; ?>" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Cidade</td>
      <td><input name="cidade" class='class02' type="text" id="cidade" value="<? echo $cidade; ?>" size="50" maxlength="50"></td>
      <td>Estado</td>
      <td><select name="estado" class='class02'id="estado">
...
?>
    ...
    <tr> 
      <td>Cep</td>
      <td><input name="cep" class='class02' type="text" id="cep" value="<? echo $cep; ?>" size="9" maxlength="9">
Use o formato 00000-000</td>
      <td>Telefone</td>
      <td><input name="telefone" class='class02' type="text" id="endereco5" value="<? echo $telefone; ?>" size="15" maxlength="14"> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Celular</td>
      <td><input name="celular" class='class02' type="text" id="telefone" value="<? echo $celular; ?>" size="15" maxlength="14"></td>
      <td>E-Mail</td>
      <td><input name="email" class='class02' type="text" id="email" value="<? echo $email; ?>" size="50" maxlength="50"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Obs</td>
      <td colspan="2"><textarea name="obs" class='class02' cols="50" rows="7" id="obs"><? echo $obs; ?></textarea></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Sal&aacute;rio R$ </td>
      <td><strong><font color="#0000FF"><? echo "R$ ".$salario; ?></font></strong>
  ...
  formato 0000.00 </td>
    ...
    <tr>
      <td>Senha</td>
      <td><input name="senha" type="password" class='class02' id="senha" value="<? echo $senha; ?>" readonly></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
$senha = $_SESSION['senha'];
?>
        <input type="submit" class='class01' name="Submit" value="Salvar"></td><td><div align="right"> </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
