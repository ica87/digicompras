...
<p><strong><font color="#0000FF">DESATIVANDO CART&Atilde;O DIGICOMPRAS</font></strong></p>
...
<table width="100%" border="0" cellspacing="4">
    <tr>
      ...
      <td width="7%"><strong><font color="#0000FF"><? echo $datacadastro; ?></font></strong></td>
      <td width="14%"><p>Status da Produ&ccedil;&atilde;o</p>      </td>
    ...
    <tr>
      ...
      <td colspan="2">N&ordm; do cart&atilde;o </td>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $nome; ?></font></strong>
        <input name="nome" type="hidden" id="nome2" value="<? echo $nome; ?>"></td><td colspan="2">Fun&ccedil;&atilde;o</td>
      <td><strong>
    ...
    <tr> 
      ...
      <td width="33%"><strong><font color="#0000FF"><? echo $data_nasc; ?></font></strong>
        <input name="data_nasc" type="hidden" id="data_nasc" value="<? echo $data_nasc; ?>"></td><td colspan="2">Sexo</td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $rg; ?></font></strong>
        ...
        &Oacute;rg&atilde;o 
          ...
          <input name="orgao" type="hidden" id="cpf3" value="<? echo $orgao; ?>"></td><td colspan="2">Emiss&atilde;o</td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $pai; ?></font></strong>
        <input name="pai" type="hidden" id="pai" value="<? echo $pai; ?>"></td><td colspan="2">M&atilde;e</td>
    ...
    <tr> 
      ...
      </td><td colspan="2">N&uacute;mero</td>
    ...
    <tr> 
      ...
      </td><td colspan="2">Complemento</td>
    ...
    <tr>
      ...
      <td><strong><font color="#0000FF"><? echo $cidade; ?></font></strong>
        <input name="cidade" type="hidden" id="cidade" value="<? echo $cidade; ?>"></td><td colspan="2">Estado</td>
  ...
  Formato 00000-000</td>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $celular; ?></font></strong>
        <input name="celular" type="hidden" id="telefone" value="<? echo $celular; ?>"></td><td colspan="2">E-Mail</td>
        <td><strong><font color="#0000FF"><? echo $email; ?></font></strong>
          <input name="email" type="hidden" id="email" value="<? echo $email; ?>"></td><td>&nbsp;</td>
    </tr>
    <tr>
      <td>Obs</td>
      <td colspan="3"><strong><font color="#0000FF"><? echo $obs; ?></font></strong>      <input name="obs" type="hidden" id="obs" value="<? echo $obs; ?>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    formato 0000.00 </td><td colspan="2"><div align="center">Limite</div></td>
      <td><strong><font color="#0000FF">R$ <? echo $limite; ?> 
        <input name="limite" type="hidden" id="complemento3" value="<? echo $limite; ?>">
      </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Senha</td>
      <td><strong></strong>
      <input name="senha" type="hidden" id="senha" value="<? echo $senha; ?>"></td><td colspan="2">&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
?>
        <input type="submit" name="Submit" value="Alterar dados do Usu&aacute;rio"> 
          <input type="reset" name="Submit2" value="Limpar"> </td><td colspan="2"><div align="right"> </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
