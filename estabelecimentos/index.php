...
<div align="center">
  <form action="../loja/concessionarias/index.php" method="post" name="form4" target="_blank">
    <?
...
?>
    <input type="submit" class="class01" name="Submit4" value="Loja - Vendas / Or&ccedil;amentos">
  </form>
</div>
