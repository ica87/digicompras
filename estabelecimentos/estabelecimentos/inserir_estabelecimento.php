...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      <td>&nbsp;</td>
      <td colspan="3"><strong><font color="#FF0000" size="4">Cadastro 
        de estabelecimentos!. Caso n&atilde;o possua a categoria nos envie um email que criaremos para voc&ecirc; <font color="#0000FF">digicompras@digicompras.com.br </font></font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Data Cadastro </td>
      <td><strong><font color="#FF0000"><? echo date('d-m-Y'); ?></font></strong> <font color="#FF0000">
      ...
      <td><input name="foto" type="file" id="arquivo2"></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Categoria</td>
...
?>
      ...
      <td><strong><font color="#0000FF"><? echo $proprietario; ?></font></strong>
      <input name="operador_atendente" type="hidden" id="operador_atendente" value="<? echo $proprietario; ?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr>
      <td>CNPJ</td>
      <td><input name="cnpj" type="text" id="cnpj" size="15" maxlength="15"></td>
      <td>INSCR EST </td>
...
?>
    ...
    <tr>
      <td>Obs</td>
      <td colspan="2"><textarea name="obs" cols="50" rows="7" id="obs"></textarea>
      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      ...
      <td>Plano</td>
      <td><select name="plano" id="select3">
        <option selected>Selecione</option>
        <?
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="banco" type="hidden" id="banco" value=""></td>
      <td>&nbsp;</td>
      <td><input name="usuario" type="hidden" id="usuario" value=""></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="agencia" type="hidden" id="agencia" value=""></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="conta" type="hidden" id="conta" value=""></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td><input name="aliquota" type="hidden" id="aliquota" value="5">        
      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    ...
    <tr>
      <td colspan="2"><strong><font color="#0000FF">
        ...
        <input name="operador" type="hidden" id="operador3" value="<? echo $proprietario; ?>">
        ...
        <input name="cidade_estabelecimento" type="hidden" id="cidade_estabelecimento" value="<? echo $cidade; ?>">
        <input name="tel_estabelecimento" type="hidden" id="tel_estabelecimento" value="<? echo $telefone; ?>">
        <input name="email_estabelecimento" type="hidden" id="email_estabelecimento" value="<? echo $email; ?>">
    ...
    <tr> 
      <td colspan="2">&nbsp;         </td><td><div align="right"> </div></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
...
<form name="form1" method="post" action="">
  <table width="100%" border="0" cellspacing="4">
    <tr>
      ...
      </strong><strong><font color="#0000FF"><? echo $proprietario; ?> </font></strong><strong><font color="#0000FF"> </font></strong></td>
