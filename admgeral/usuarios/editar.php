...
?>
    ...
    <tr> 
      ...
      <td width="36%"><input name="data_nasc" type="text" id="data_nasc" value="<? echo $data_nasc; ?>" size="15" maxlength="10"></td>
      <td width="20%">Sexo</td>
...
Use o formato 00000-000</td>
  ...
  formato 0000.00 </td>
      ...
      <td><strong><font color="#0000FF">R$ <? echo $limite; ?></font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Senha</td>
      <td><input name="senha" type="password" id="senha" value="<? echo $senha; ?>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
