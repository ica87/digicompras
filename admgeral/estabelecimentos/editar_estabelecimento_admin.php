...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td><? printf("<a href='foto_admin.php?chamar=$codigo' >Trocar foto</a> ");?></td>
    <td>&nbsp;</td>
    <td width="30%">&nbsp;</td>
    <?
if($reg==1){
...
<form name="form1" method="post" action="grava_editar_estabelecimento_admin.php">
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="aliquota" type="hidden" id="aliquota">  
      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
