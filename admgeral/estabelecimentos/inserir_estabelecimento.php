...
?>
    ...
    $sql = "select * from operadores where funcao = 'VENDEDOR COMISSIONADO DE CARTAO FIDELIDADE' order by nome asc";
    $result = mysql_query($sql);
    while($x=mysql_fetch_array($result)){
...
?>
    ...
    <tr>
      <td>Obs</td>
      <td><textarea name="obs" cols="50" rows="7" id="obs"></textarea>
      </td>
      <td>Atividade</td>
      <td><textarea name="atividade" cols="50" rows="7" id="atividade"><? echo "$atividade"; ?></textarea></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Senha</td>
    ...
    $sql = "select * from planos order by plano desc";
    $result = mysql_query($sql);
    while($x=mysql_fetch_array($result)){
...
?>
    ...
    <tr>
      <td>M&iacute;nimo de Pontos</td>
      <td><input name="teto_de_pontos" type="text" id="teto_de_pontos" value="1000.00"></td>
      <td>Comiss&atilde;o Digicompras</td>
      <td><input name="comissao_digicompras" type="text" id="comissao_digicompras" value="0" size="5">
%</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <input name="banco" type="hidden" id="banco" value=""></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
