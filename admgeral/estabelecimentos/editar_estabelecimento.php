...
$valor = $linha[52];
$atividade = $linha[56];
$comissao_digicompras = $linha[57];
$teto_de_pontos = $linha[58];

}

$aliquota_de_comissao_digicompras = bcmul($comissao_digicompras,100,2);
...
<form name="form1" method="post" action="grava_editar_estabelecimento.php">
  <table width="100%" border="0" cellspacing="4">
    <tr>
      <td>&nbsp;</td>
      <td colspan="3"><strong><font color="#FF0000" size="4">Tela de altera&ccedil;&atilde;o do cadastro de estabelecimentos!. </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>C&oacute;digo</td>
...
?>
    ...
    <tr>
      <td>Obs</td>
      <td><textarea name="obs" cols="50" rows="7" id="obs"><? echo $obs; ?></textarea></td>
      <td>Atividade</td>
    ...
    <tr>
      <td>Senha</td>
      <td><input name="senha" type="text" id="senha" value="<? echo $senha_estab; ?>"></td>
      <td>Plano</td>
...
?>
    ...
    <tr>
      ...
      <td><input name="teto_de_pontos" type="text" id="teto_de_pontos" value="<? echo "$teto_de_pontos"; ?>"></td>
      <td>Comiss&atilde;o Digicompras       </td>
      <td><input name="comissao_digicompras" type="text" id="comissao_digicompras" value="<? echo "$aliquota_de_comissao_digicompras"; ?>" size="5">
        %</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="aliquota" type="hidden" id="aliquota">      <input name="banco" type="hidden" id="banco" value="<? echo $banco; ?>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
