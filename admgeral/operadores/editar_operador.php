...
?>
    ...
    <tr>
      ...
      <td><select name="classe" id="classe">
        <option selected><? echo $classe; ?></option>
        <option>A</option>
        <option>B</option>
        <option>C</option>
      </select></td>
...
Use o formato 00000-000</td>
    ...
    <tr>
      ...
      <td>Senha</td>
      <td><input name="senha" type="text" id="senha2" value="<? echo $senha_op; ?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Sal&aacute;rio</td>
      <td><input name="salario" type="text" id="salario2" value="<? echo $salario; ?>"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
...
?>
    ...
    <tr>
      <td>Meta INSS </td>
      <td><input name="meta" type="text" id="meta" value="<? echo $meta; ?>"></td>
      <td>Meta CP </td>
      <td><input name="meta_cp" type="text" id="meta_cp" value="<? echo $meta_cp; ?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Meta CPCDC </td>
      <td><input name="meta_cpcdc" type="text" id="meta_cpcdc" value="<? echo $meta_cpcdc; ?>"></td>
      <td>Meta VEICULOS </td>
      <td><input name="meta_veiculos" type="text" id="meta_veiculos" value="<? echo $meta_veiculos; ?>"></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><div align="center">Mensagem ao Funcion&aacute;rio</div>        <div align="center"></div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td colspan="4"><div align="center">Hist&oacute;rico de mensagens para o funcion&aacute;rio </div></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td colspan="4"><div align="center">
        <textarea name="historico_mensagens" cols="100" rows="10" readonly id="textarea"><?  
$sql = "SELECT * FROM mensagens_ao_funcionario where nome_operador = '$nome' order by codigo desc";
$res = mysql_query($sql);
$reg = 0;
//echo "<tr>";
while($linha=mysql_fetch_row($res)) {
...
?>
        ...
        </font></strong>        <input type="submit" name="Submit" value="Alterar dados do Operador"> 
      <input type="reset" name="Submit2" value="Limpar"> <div align="right"> </div></td><td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
  ...
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td valign="top" bgcolor="#CCCCCC"><strong>Data do Cadastro <br>
            <font color="#0000FF"><? echo $dataalteracao_u; ?> </font></strong></td>
      <td valign="top" bgcolor="#CCCCCC"><strong>Hora que foi efetuado o Cadastro <br>
            <font color="#0000FF"><? echo $horaalteracao_u; ?> </font></strong></td>
