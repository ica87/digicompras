...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      ...
      <td>      <strong><font color="#0000FF"><? echo "Funcionário"; ?></font></strong>
    ...
    <tr> 
      ...
      <td><select name="funcao" id="estadocivil">
        <option selected>Selecione</option>
        <?


    $sql = "select * from funcoes order by funcao asc";
...
Use o formato 00000-000</td>
    ...
    <tr>
      ...
      <td>Senha</td>
      <td><input name="senha" type="text" id="senha2"></td>
    </tr>
    <tr>
      <td>Sal&aacute;rio</td>
      <td><input name="salario" type="text" id="salario4"></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td><font color="#000000">Banco</font>      </td>
...
?>
    ...
    <tr>
      <td>Ag&ecirc;ncia</td>
      <td><input name="agencia" type="text" id="agencia2"></td>
      <td>Conta</td>
      <td><input name="conta" type="text" id="conta2"></td>
    </tr>
    <tr>
      <td>Meta INSS </td>
      <td><input name="meta" type="text" id="meta"></td>
      <td>Meta CP </td>
      <td><input name="meta_cp" type="text" id="meta_cp"></td>
    </tr>
    <tr>
      <td>Meta CPCDC </td>
      <td><input name="meta_cpcdc" type="text" id="meta_cpcdc"></td>
      <td>Meta VEICULOS </td>
      <td><input name="meta_veiculos" type="text" id="meta_veiculos"></td>
    </tr>
    <tr>
      <td colspan="2"><div align="center">Mensagem ao Funcion&aacute;rio</div></td>
      <td colspan="2"><div align="center"></div></td>
    </tr>
    <tr>
      <td colspan="2"><textarea name="mensagem" cols="50" rows="7" id="mensagem"></textarea></td>
      <td colspan="2">&nbsp;</td>
    </tr>
    <tr> 
      <td colspan="2"><?
...
?>
        ...
        <input name="cel_operador" type="hidden" id="cel_operador2" value="<? echo $celular; ?>">
        <input name="email_operador" type="hidden" id="email_operador2" value="<? echo $email; ?>">
        <input name="estabelecimento" type="hidden" id="estabelecimento2" value="<? echo $estabelecimento; ?>">
        <input name="cidade_estabelecimento" type="hidden" id="cidade_estabelecimento2" value="<? echo $cidade_estabelecimento; ?>">
        <input name="tel_estabelecimento" type="hidden" id="tel_estabelecimento2" value="<? echo $tel_estabelecimento; ?>">
        <input name="email_estabelecimento" type="hidden" id="email_estabelecimento2" value="<? echo $email_estabelecimento; ?>">
        </font></strong>        <input type="submit" name="Submit" value="Cadastrar Operador"> 
