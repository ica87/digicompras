...
if(($numeropermitido==$dz1fixa) or ($numeropermitido==$dz3fixa) or ($numeropermitido==$dz5fixa) ){
...
?>
    ...
    <tr>
      <td valign="top"><?
		  ...
		  if($solicitacao=="gravarresultado"){
			  
$comando = "update `$db`.`megasena_resultado` set `dz1` = '$dz1_pesquisar',`dz2` = '$dz2_pesquisar',`dz3` = '$dz3_pesquisar',`dz4` = '$dz4_pesquisar',`dz5` = '$dz5_pesquisar',`dz6` = '$dz6_pesquisar' where `megasena_resultado`. `codigo` = '1'";
mysql_query($comando,$conexao);
...
$sql3 = "SELECT * FROM megasena_combinacoespossiveis where dz1 = '$dz1_pesquisar' and  dz2 = '$dz2_pesquisar' and dz3 = '$dz3_pesquisar' and dz4 = '$dz4_pesquisar' and dz5 = '$dz5_pesquisar' and dz6 = '$dz6_pesquisar' limit 1";
$res3 = mysql_query($sql3);
$registro_combinacao1 = mysql_num_rows($res3);
		
		
$sql4 = "SELECT * FROM megasena_combinacoespossiveis where dz2 = '$dz2_pesquisar' and dz3 = '$dz3_pesquisar' and dz4 = '$dz4_pesquisar' and dz5 = '$dz5_pesquisar' and dz6 = '$dz6_pesquisar' and dz1 = '$dz1_pesquisar' limit 1";
$res4 = mysql_query($sql4);
$registro_combinacao2 = mysql_num_rows($res4);
		
$sql5 = "SELECT * FROM megasena_combinacoespossiveis where dz3 = '$dz3_pesquisar' and dz4 = '$dz4_pesquisar' and dz5 = '$dz5_pesquisar' and dz6 = '$dz6_pesquisar' and dz1 = '$dz1_pesquisar' and dz2 = '$dz2_pesquisar' limit 1";
$res5 = mysql_query($sql5);
$registro_combinacao3 = mysql_num_rows($res5);
		
$sql6 = "SELECT * FROM megasena_combinacoespossiveis where dz4 = '$dz4_pesquisar' and dz5 = '$dz5_pesquisar' and dz6 = '$dz6_pesquisar' and dz1 = '$dz1_pesquisar' and dz2 = '$dz2_pesquisar' and dz3 = '$dz3_pesquisar' limit 1";
$res6 = mysql_query($sql6);
$registro_combinacao4 = mysql_num_rows($res6);
		
$sql7 = "SELECT * FROM megasena_combinacoespossiveis where dz5 = '$dz5_pesquisar' and dz6 = '$dz6_pesquisar' and dz1 = '$dz1_pesquisar' and dz2 = '$dz2_pesquisar' and dz3 = '$dz3_pesquisar' and dz4 = '$dz4_pesquisar' limit 1";
$res7 = mysql_query($sql7);
$registro_combinacao5 = mysql_num_rows($res7);
		
$sql8 = "SELECT * FROM megasena_combinacoespossiveis where dz6 = '$dz6_pesquisar' and dz1 = '$dz1_pesquisar' and dz2 = '$dz2_pesquisar' and dz3 = '$dz3_pesquisar' and dz4 = '$dz4_pesquisar' and dz5 = '$dz5_pesquisar' limit 1";
$res8 = mysql_query($sql8);
$registro_combinacao6 = mysql_num_rows($res8);
...
alert('ATENCAO!!!... COMBINACAO JA REGISTRADA! $dz1_pesquisar - $dz2_pesquisar - $dz3_pesquisar - $dz4_pesquisar - $dz5_pesquisar - $dz6_pesquisar');
...
<table width="100%" border="0">
  <tbody>
    <tr>
      <td width="44%" align="left" valign="top"><form name="form2" method="post" action="index.php">
  <table width="95%" border="1">
    <tbody>
      <tr>
        <td colspan="3" align="center"><input class="class01"  type="submit" name="Submit4" value="<? if($fixardezenas=="fixar"){ echo "Desafixar Dezenas"; }else{ echo "Fixar Dezenas"; } ?>"></td>
      </tr>
      <tr>
        <td align="center"><input name="fixardezenas" type="hidden" id="fixardezenas" value="<? if($fixardezenas=="fixar"){ echo "desafixar"; }else{ echo "fixar"; } ?>">
          DZ1</td>
        <td align="center">DZ3</td>
        <td align="center">DZ5</td>
      </tr>
      <tr>
        <td align="center"><input name="dz1fixa" type="text" id="dz1fixa" value="<? echo "$dz1fixa"; ?>" size="5"></td>
        <td align="center"><input name="dz3fixa" type="text" id="dz3fixa" value="<? echo "$dz3fixa"; ?>" size="5"></td>
        <td align="center"><input name="dz5fixa" type="text" id="dz5fixa" value="<? echo "$dz5fixa"; ?>" size="5"></td>
      </tr>
    </tbody>
  </table>
</form></td>
...
?>
      ...
      <tr>
        <td align="center" valign="top"><input name="dz1_pesquisar" type="text" id="dz1_pesquisar" value="<? echo "$dz1_pesquisar"; ?>" size="5"></td>
        <td align="center" valign="top"><input name="dz2_pesquisar" type="text" id="dz2_pesquisar" value="<? echo "$dz2_pesquisar"; ?>" size="5"></td>
        <td align="center" valign="top"><input name="dz3_pesquisar" type="text" id="dz3_pesquisar" value="<? echo "$dz3_pesquisar"; ?>" size="5"></td>
        <td align="center" valign="top"><input name="dz4_pesquisar" type="text" id="dz4_pesquisar" value="<? echo "$dz4_pesquisar"; ?>" size="5"></td>
        <td align="center" valign="top"><input name="dz5_pesquisar" type="text" id="dz5_pesquisar" value="<? echo "$dz5_pesquisar"; ?>" size="5"></td>
        <td align="center" valign="top"><input name="dz6_pesquisar" type="text" id="dz6_pesquisar" value="<? echo "$dz6_pesquisar"; ?>" size="5"></td>
      </tr>
      <tr>
        <td colspan="6" align="center" valign="top"><input class="class01"  type="submit" name="Submit2" value="Verificar"></td>
        </tr>
    </table>
</form></td>
      <td width="3%">&nbsp;</td>
      <td width="29%"><form name="form1" method="post" action="index.php">
...
?>
          <? 
			...
			$sql = "SELECT * FROM megasena_resultado";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
	
	$dz1_pesquisar = $linha[1];
	$dz2_pesquisar = $linha[2];
	$dz3_pesquisar = $linha[3];
	$dz4_pesquisar = $linha[4];
	$dz5_pesquisar = $linha[5];
	$dz6_pesquisar = $linha[6];
	
}

			
			?>
          <input name="solicitacao" type="hidden" id="solicitacao" value="gravarresultado">
          DZ1</div></td>
        <td width="18%" valign="top"><div align="center">DZ2</div></td>
        <td width="16%" valign="top"><div align="center">DZ3</div></td>
        <td width="14%" valign="top"><div align="center">DZ4</div></td>
      ...
      <tr>
        <td colspan="6" align="center" valign="top"><input class="class01"  type="submit" name="Submit2" value="Resultado"></td>
        </tr>
    </table>
</form></td>
    </tr>
...
<table width="95%" border="0" align="center">
  <tbody>
      <tr>
        <th width="18%" valign="top" scope="col"><table width="100%" border="0" align="left">
    <tbody>
      <tr>
        <td width="73%" valign="top"><table width="100%" border="0" align="left">
          <tbody>
            <tr>
              <th bgcolor="#cacaca" scope="col"><form name="form4" method="post" action="index.php">
                <input name="solicitacao" type="hidden" id="solicitacao" value="zerar">
                <input type="submit" name="Submit6" value="Zerar">
                </form></th>
              <th bgcolor="#cacaca" scope="col"><form name="form4" method="post" action="index.php">
                <input name="solicitacao" type="hidden" id="solicitacao" value="liberarparasorteio">
                <input type="submit" name="Submit3" value="Liberar p/ Sorteio">
                </form></th>
              </tr>
            <tr>
...
$reg_num_encontrados++;
				  ...
				  ?>Selecionados</th>
              <th width="51%" bgcolor="#cacaca" scope="col">#</th>
              </tr>
            <?
...
?>
            <tr>
              <td bgcolor="#cacaca"><? echo "$numeroencontrado $sorteado"; ?></td>
...
?>
        ...
        <th width="43%" valign="top" scope="col"><table width="95%"  border="0" align="center">
          <tr>
            <td colspan="6" align="center" valign="top" bgcolor="#C5BDBE"><form name="form4" method="post" action="index.php">
              <?
	if($solicitacao=="gerarcombinacao2"){
...
$numerolistado = $linha[1];
	
	

if(($reg_dezena==1) or ($reg_dezena==7) or ($reg_dezena==13) or ($reg_dezena==19) or ($reg_dezena==25) or ($reg_dezena==31) or ($reg_dezena==37) or ($reg_dezena==43) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz1` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
	
if(($reg_dezena==2) or ($reg_dezena==8) or ($reg_dezena==14) or ($reg_dezena==20) or ($reg_dezena==26) or ($reg_dezena==32) or ($reg_dezena==38) or ($reg_dezena==44) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz2` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
	
if(($reg_dezena==3) or ($reg_dezena==9) or ($reg_dezena==15) or ($reg_dezena==21) or ($reg_dezena==27) or ($reg_dezena==33) or ($reg_dezena==39) or ($reg_dezena==45) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz3` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
	
if(($reg_dezena==4) or ($reg_dezena==10) or ($reg_dezena==16) or ($reg_dezena==22) or ($reg_dezena==28) or ($reg_dezena==34) or ($reg_dezena==40) or ($reg_dezena==46) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz4` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
	
if(($reg_dezena==5) or ($reg_dezena==11) or ($reg_dezena==17) or ($reg_dezena==23) or ($reg_dezena==29) or ($reg_dezena==35) or ($reg_dezena==41) or ($reg_dezena==47) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz5` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
	
if(($reg_dezena==6) or ($reg_dezena==12) or ($reg_dezena==18) or ($reg_dezena==24) or ($reg_dezena==30) or ($reg_dezena==36) or ($reg_dezena==42) or ($reg_dezena==48) ){
$comando = "update `$db`.`megasena_cartelatemporaria` set `dz6` = '$numerolistado' where `megasena_cartelatemporaria`. `codigo` = '1'";
mysql_query($comando,$conexao);
}
...
$sql20 = "SELECT * FROM megasena_cartelatemporaria";
...
$sql21 = "SELECT * FROM megasena_combinacoes where dz1 = '$dz1listada' and  dz2 = '$dz2listada' and dz3 = '$dz3listada' and dz4 = '$dz4listada' and dz5 = '$dz5listada' and dz6 = '$dz6listada' limit 1";
$res21 = mysql_query($sql21);
$registro_lista1 = mysql_num_rows($res21);
		
	if($registro_lista1>=1){
	
}
else{
	
	$comando = "insert into megasena_combinacoes(dz1,dz2,dz3,dz4,dz5,dz6)
values('$dz1listada','$dz2listada','$dz3listada','$dz4listada','$dz5listada','$dz6listada')";
mysql_query($comando,$conexao);
...
//$registro_combinacao6 = mysql_num_rows($res8);
	...
	?>
              <input name="solicitacao" type="hidden" id="solicitacao" value="gerarcombinacao2">
              <input type="submit" name="Submit7" value="Gerar">
            </form></td>
          </tr>
          <tr>
            <td colspan="6" align="center" valign="top" bgcolor="#C5BDBE"><form name="form4" method="post" action="index.php">
              TOTAL DE COMBINA&Ccedil;&Otilde;ES
              <?
$sql = "SELECT * FROM megasena_combinacoes order by codigo asc";
$res = mysql_query($sql);
...
$totaldosjogos = bcmul($registro_combinacao,3.50,2);
	echo " TOTAL DOS JOGOS R$ $totaldosjogos";
	  ?>
              <input name="solicitacao" type="hidden" id="solicitacao" value="zerarcombinacoes">
              <input type="submit" name="Submit7" value="Zerar">
            </form></td>
          </tr>
          <tr>
            <td width="13%" valign="top" bgcolor="#C5BDBE"><div align="center">
              <input name="solicitacao2" type="hidden" id="solicitacao3" value="verificacombinacao">
              <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
              DZ1</div></td>
            <td width="18%" valign="top" bgcolor="#C5BDBE"><div align="center">DZ2</div></td>
            <td width="16%" valign="top" bgcolor="#C5BDBE"><div align="center">DZ3</div></td>
            <td width="14%" valign="top" bgcolor="#C5BDBE"><div align="center">DZ4</div></td>
            <td width="13%" valign="top" bgcolor="#C5BDBE"><div align="center">DZ5</div></td>
            <td width="13%" valign="top" bgcolor="#C5BDBE"><div align="center">DZ6</div></td>
          </tr>
          <?
	
	$sql = "SELECT * FROM megasena_combinacoes order by codigo desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$registro_combinacao = mysql_num_rows($res);
...
?>
          <tr>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz1_sorteada"; ?></td>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz2_sorteada"; ?></td>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz3_sorteada"; ?></td>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz4_sorteada"; ?></td>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz5_sorteada"; ?></td>
            <td align="center" valign="top" bgcolor="#C5BDBE"><? echo "$dz6_sorteada"; ?></td>
          </tr>
          <? } ?>
        </table></th>
        <th width="39%" valign="top" scope="col">
			<div style="overflow: auto; height: 600px">
			<table width="95%"  border="0" align="center">
    <tr>
      <td colspan="6" align="center" valign="top"><form name="form4" method="post" action="index.php">
        <input name="solicitacao" type="hidden" id="solicitacao" value="gerarcombinacao">
        <input type="submit" name="Submit5" value="Gerar">
      </form></td>
    </tr>
    <tr>
...
$totaldosjogos = bcmul($registro_combinacao,3.50,2);
	echo " TOTAL DOS JOGOS R$ $totaldosjogos";
	  ?>
        <input name="solicitacao" type="hidden" id="solicitacao" value="zerarcombinacoes2">
          <input type="submit" name="Submit" value="Zerar">
    </form></td>
    </tr>
    <tr>
      <td width="13%" valign="top"><div align="center">
...
?>
    <tr>
      <td align="center" valign="top" <? if(($dz1_sorteada==$dz1_pesquisar) or ($dz1_sorteada==$dz2_pesquisar) or ($dz1_sorteada==$dz3_pesquisar) or ($dz1_sorteada==$dz4_pesquisar) or ($dz1_sorteada==$dz5_pesquisar) or ($dz1_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz1_sorteada"; ?></td>
      <td align="center" valign="top" <? if(($dz2_sorteada==$dz2_pesquisar) or ($dz2_sorteada==$dz2_pesquisar) or ($dz2_sorteada==$dz3_pesquisar) or ($dz2_sorteada==$dz4_pesquisar) or ($dz2_sorteada==$dz5_pesquisar) or ($dz2_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz2_sorteada"; ?></td>
      <td align="center" valign="top" <? if(($dz3_sorteada==$dz3_pesquisar) or ($dz3_sorteada==$dz2_pesquisar) or ($dz3_sorteada==$dz3_pesquisar) or ($dz3_sorteada==$dz4_pesquisar) or ($dz3_sorteada==$dz5_pesquisar) or ($dz3_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz3_sorteada"; ?></td>
      <td align="center" valign="top" <? if(($dz4_sorteada==$dz4_pesquisar) or ($dz4_sorteada==$dz2_pesquisar) or ($dz4_sorteada==$dz3_pesquisar) or ($dz4_sorteada==$dz4_pesquisar) or ($dz4_sorteada==$dz5_pesquisar) or ($dz4_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz4_sorteada"; ?></td>
      <td align="center" valign="top" <? if(($dz5_sorteada==$dz5_pesquisar) or ($dz5_sorteada==$dz2_pesquisar) or ($dz5_sorteada==$dz3_pesquisar) or ($dz5_sorteada==$dz4_pesquisar) or ($dz5_sorteada==$dz5_pesquisar) or ($dz5_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz5_sorteada"; ?></td>
      <td align="center" valign="top" <? if(($dz6_sorteada==$dz6_pesquisar) or ($dz6_sorteada==$dz2_pesquisar) or ($dz6_sorteada==$dz3_pesquisar) or ($dz6_sorteada==$dz4_pesquisar) or ($dz6_sorteada==$dz5_pesquisar) or ($dz6_sorteada==$dz6_pesquisar) ){ echo "bgcolor='#091594' class='style5'"; }else{ echo "#FFFFFF"; } ?>><? echo "$dz6_sorteada"; ?></td>
    </tr>
    <? } ?>
  </table>
			</div>
          ...
          <tbody>
            <tr>
              <th bgcolor="#cacaca" scope="col"><form name="form4" method="post" action="index.php">
                ...
                <input type="submit" name="Submit8" value="Limite">
              </form></th>
            </tr>
            <tr>
              <th width="49%" bgcolor="#cacaca" scope="col"><?
...
$sql = "SELECT * FROM megasena order by quantidade desc limit $limite";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg_num_encontrados++;
...
$dezena = $linha[1];
	...
	$quantidadebola1 = $linha[3];
	$quantidadebola2 = $linha[4];
	$quantidadebola3 = $linha[5];
	$quantidadebola4 = $linha[6];
	$quantidadebola5 = $linha[7];
	$quantidadebola6 = $linha[8];

?>
            <tr>
              <td align="center" bgcolor="#cacaca"><? echo "$dezena - $quantidade --->>> DZ1 $quantidadebola1 - DZ2 $quantidadebola2 - DZ3 $quantidadebola3 - DZ4 $quantidadebola4 - DZ5 $quantidadebola5 - DZ6 $quantidadebola6"; ?></td>
            </tr>
            <tr>
  ...
  <table width="100%" border="0" align="center">
    <tbody>
      <tr>
        <th bgcolor="#cacaca" scope="col">&nbsp;</th>
      </tr>
      <tr>
...
$sql = "SELECT * FROM megasena_todosresultados order by concurso desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg_num_encontrados++;
...
?>
      <tr>
        <td align="center" bgcolor="#cacaca"><? echo "$bola1 - $bola2 - $bola3 - $bola4 - $bola5 - $bola6"; ?></td>
      </tr>
      <tr>
        <td align="center" bgcolor="#cacaca">&nbsp;</td>
      </tr>
