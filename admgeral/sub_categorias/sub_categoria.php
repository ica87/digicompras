...
<p class="style2">Altera&ccedil;&atilde;o de nome de Sub categorias. <span class="style3">Aten&ccedil;&atilde;o! A mudan&ccedil;a de nome de Sub categoria afetar&aacute; todos os produtos relacionados a ela, voc&ecirc; dever&aacute; alerar todos eles para a nova Sub categoria.</span> </p>
<p><a href="menu.php">Voltar</a></p>
<form action="autalizar_sub_categoria.php" method="post" name="form2">
...
?>
        ...
        <tr>
          <td height="40">Altere o  nome da Sub Categoria</td>
          <td><input name="sub_categoria" type="text" id="sub_categoria" value="<? echo $linha[1]; ?>" size="50"></td>
