...
<p class="style2">Exclus&atilde;o de cor de materiais </p>
<p><a href="menu.php">Voltar</a></p>
<form action="excluir_cor_material.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. da cor do material a ser exclu&iacute;da<br></td>
