...
<table width="100%"  border="1" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
  <tr>
    ...
    <td width="2%" rowspan="14" bordercolor="#000000" bgcolor="#CCCCCC"><div align="center"></div>      <div align="center" class="style1 style4"></div></td>
  </tr>
  <tr>
    <td colspan="6" valign="top" bordercolor="#000000"><? printf("<img src='../../imagens/$logo' border='0' width='250' height='60'>"); ?></td>
    <td width="11%" valign="top" bordercolor="#000000"><div align="center"><strong>DUPLICATA</strong></div></td>
  </tr>
  <tr>
    <td colspan="3" bordercolor="#000000"><div align="center" class="style17"><? echo $razaosocial_empresa; ?><br>
        ...
        <? echo $telefone_empresa; ?><br>        <? echo $cidade_empresa; ?> - <? echo $estado_empresa; ?></div></td>
  ...
  <tr>
    <td width="3%" rowspan="10" align="center" valign="middle" bordercolor="#000000"><div class="style14"><? echo $razaosocial_empresa; ?><br>
        <br>
        <? echo "_______________________"; ?><br>
      <? echo "(Assinatura do Emitente)"; ?></div></td>
    <td width="14%" bordercolor="#000000"><div align="center" class="style10"></div></td>
    <td width="18%" bordercolor="#000000"><div align="center" class="style11 style16"> VALOR</div></td>
    <td width="21%" bordercolor="#000000"><div align="center" class="style11 style16">DUPLICATA N&ordm;</div></td>
    <td width="12%" bordercolor="#000000"><div align="center" class="style10"><strong>Vencimento</strong></div></td>
...
?>
  ...
  <tr>
    ...
    <td colspan="2" valign="bottom" bordercolor="#000000"><div align="center" class="style11 style16">PROTESTAR AP&Oacute;S 5 DIS DO VENCIMENTO.<br>
COBRAR JUROS DE MORA 0,2% AO DIA.</div></td>
