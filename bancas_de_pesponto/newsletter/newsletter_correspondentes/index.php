...
<html>
<head>
<title>NEWSLETTER - Envie comunicados e promo&ccedil;&otilde;es para todos seus correspondentes de uma s&oacute; vez!</title>
...
<form action="envia.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td colspan="4"><span class="style2">NEWSLETTER - Envie comunicados e promo&ccedil;&otilde;es para todos seus correspondentes de uma s&oacute; vez!</span></td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2">&nbsp;</td>
