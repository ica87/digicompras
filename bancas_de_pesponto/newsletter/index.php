...
<html>
<head>
<title>NEWSLETTER - Envie comunicados e promo&ccedil;&otilde;es para todos seus clientes de uma s&oacute; vez!</title>
...
<form action="envia.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><strong>Selecione o grupo que deseja enviar</strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
