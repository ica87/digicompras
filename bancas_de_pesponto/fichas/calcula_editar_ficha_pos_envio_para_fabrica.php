...
alert('ATENÇÃO!!!... VOCÊ DEVE PREENCHER O CAMPO JUSTIFICATIVA PARA QUE CONSIGA CONCLUIR ESSA AÇÃO!!!...');
...
echo "ATENÇÃO!!!... VOCÊ DEVE PREENCHER O CAMPO JUSTIFICATIVA PARA QUE CONSIGA CONCLUIR ESSA AÇÃO!!!...";
}
else{
echo "<input type='submit' name='Submit' value='Confirmar Alteração da Ficha Pós-Envio'>";
}
