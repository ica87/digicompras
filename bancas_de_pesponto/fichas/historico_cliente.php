...
//FIM DO SCRIPT DE ALTERAÇÃO DE STATUS E ENVIO DE EMAIL PARA A FABRICA
...
<table width="100%" border="0" cellspacing="4">
  <tr>
    <td class="style2">&nbsp;</td>
    <td class="style2"><form name="form1" method="post" action="selecione_cliente_para_abrir_orcamento.php">
...
?>
  ...
  <tr>
    <td class="style2"><strong>C&oacute;digo:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $codigo_cliente; ?></strong></font></strong></td>
    <td class="style2"><strong>Comprador:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $comprador; ?></strong></font></strong></td>
  </tr>
  <tr>
    <td class="style2"><strong>Raz&atilde;o Social:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $razaosocial; ?></strong></font></strong></td>
    <td class="style2"><strong>Celular:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $celular; ?></strong></font></strong></td>
  </tr>
  <tr>
    <td class="style2"><strong>Nome Fantasia:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $nfantasia; ?></strong></font></strong></td>
    <td class="style2"><strong>E-Mail:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $email_cliente; ?></strong></font></strong></td>
  </tr>
  <tr>
    <td width="11%" class="style2"><strong>Endere&ccedil;o:</strong></td>
    <td width="40%" class="style2"><strong><font color="#0000FF"><strong><? echo $endereco; ?> N&ordm; <font color="#0000FF"><strong><? echo $numero; ?></strong></font></strong></font></strong></td>
    <td width="13%" class="style2"><strong>CEP:</strong></td>
    <td width="36%" class="style2"><strong><font color="#0000FF"><strong><? echo $cep; ?></strong></font></strong></td>
  </tr>
  <tr>
    <td class="style2"><p><strong>Bairro:</strong></p></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $bairro; ?></strong></font></strong></td>
    <td class="style2">&nbsp;</td>
    <td class="style2">&nbsp;</td>
  </tr>
  <tr>
    <td class="style2"><strong>Cidade:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $cidade; ?> Estado <font color="#0000FF"><strong><? echo $estado; ?></strong></font></strong></font></strong></td>
    <td class="style2">&nbsp;</td>
    <td class="style2">&nbsp;</td>
  </tr>
  <tr>
    <td class="style2"><strong>Telefone:</strong></td>
    <td class="style2"><strong><font color="#0000FF"><strong><? echo $fone; ?></strong></font></strong></td>
    <td class="style2">&nbsp;</td>
    <td class="style2">&nbsp;</td>
  </tr>
</table>
...
<table width="100%" border="0" cellspacing="5">
    ...
    <tr>
      ...
      <td colspan="2" class="style2"><strong><font color="#0000FF">Inlus&atilde;o de Ficha</font></strong></td>
    </tr>
    
    <tr>
      <td class="style2">&nbsp;</td>
      <td colspan="2" class="style2"><form action="ficha.php" method="post" name="form5">
        <span class="style1">
        <?
...
?>
        ...
        <select name="modelo" class="style5" id="modelo">
          <option selected>Informe a referencia</option>
          <?
...
?>
        ...
        <strong>
        <select name="grupo" class="style5" id="grupo">
          <option selected>Informe a Banca</option>
          <?
...
?>
    ...
    <tr>
      <td class="style2">&nbsp;</td>
      <td width="39%" class="style2"><div align="center"><strong>PLANOS E FICHAS J&Aacute; EM PRODU&Ccedil;&Atilde;O  PARA ESSE CLIENTE</strong></div></td>
      <td width="42%" class="style2">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="3"><table width="140%" border="0">
        <tr>
          <td width="2%" height="15" class="style2"><div align="center" class="style2">Data entrada</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">N&ordm; Plano</div></td>
          <td width="4%" class="style2"><div align="center" class="style2">N&ordm; Ficha</div></td>
          <td width="12%" class="style2"><div align="center"><span class="style2">Status</span></div></td>
          <td width="5%" class="style2"><div align="center" class="style2">Metal Entregue?</div></td>
          <td width="6%" class="style2"><div align="center"><span class="style2">Data Envio para f&aacute;brica</span></div></td>
          <td width="3%" class="style2"><div align="center" class="style2">Quant Pares</div></td>
          <td width="4%" class="style2"><div align="center" class="style2">N&ordm; Modelo</div></td>
          <td width="4%" class="style2"><div align="center" class="style2">Metal Entregue?</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">Caixa</div></td>
          <td width="2%" class="style2"><div align="center" class="style2">Grupo</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Unit Pesponto</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Total Pesponto</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Unit Coladeira 1 </div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Total Coladeira 1 </div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Unit Coladeira 2</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Total Coladeira 2</div></td>
          <td width="3%" class="style2"><div align="center" class="style2">R$ Total Ficha</div></td>
          <td width="4%" class="style2"><div align="center" class="style2">R$ Unit Empresa</div></td>
          <td width="4%" class="style2"><div align="center" class="style2">R$ Total Empresa</div></td>
          <td width="5%" class="style2"><div align="center"><span class="style2">R$ Unit Cost. Manual</span></div></td>
          <td width="4%" class="style2"><div align="center"><span class="style2">Total Cost. Manual</span></div></td>
          <td width="4%"><div align="center" class="style2 style2">R$ Unit. Trice</div></td>
          <td width="4%"><div align="center"><span class="style2">Total Trice</span></div></td>
...
$valor_costura_manual = $linha[67];
$total_costura_manual = $linha[68];
$valor_trice = $linha[69];
$total_trice = $linha[70];
...
?>
          ...
          <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$valor_costura_manual; ?></strong></font></strong></div></td>
          <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$total_costura_manual; ?></strong></font></strong></div></td>
          <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$valor_trice; ?></strong></font></strong></div></td>
          <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$total_trice; ?></strong></font></strong></div></td>
