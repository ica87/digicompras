...
$sql = "SELECT * FROM clientes where codigo2 = '$codigo_cliente'";
$res = mysql_query($sql);
...
<form name="form1" method="post" action="grava_editar_ficha.php">
...
<table width="120%" border="0">
  <tr>
    <td width="4%" height="15"><div align="center" class="style2">Data entrada</div></td>
    <td width="5%"><div align="center" class="style2">N&ordm; Plano</div></td>
    <td width="5%"><div align="center" class="style2">N&ordm; Ficha</div></td>
    <td width="6%"><div align="center"><span class="style2">Status</span></div></td>
    <td width="3%"><div align="center" class="style2">Quant Pares</div></td>
    <td width="4%"><div align="center" class="style2">N&ordm; Modelo</div></td>
    <td width="2%"><div align="center" class="style2">Caixa</div></td>
...
?>
    ...
    <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$costura_manual; ?></strong></font></strong>
      <input name="valor_costura_manual" type="hidden" id="valor_costura_manual" value="<? echo $costura_manual; ?>">
    </div></td>
    <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$totalcosturamanual; ?></strong></font></strong>
      <input name="total_costura_manual" type="hidden" id="total_costura_manual" value="<? echo $totalcosturamanual; ?>">
    </div></td>
    <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$trice; ?></strong></font></strong>
      <input name="valor_trice" type="hidden" id="valor_trice" value="<? echo $trice; ?>">
    </div></td>
    <td><div align="center" class="style2"><strong><font color="#0000FF"><strong><? echo "R$ ".$totaltrice; ?></strong></font></strong>
...
$senha = $_SESSION['senha'];
?>
  <input type="submit" name="Submit" value="Confirmar Altera&ccedil;&atilde;o da Ficha">
