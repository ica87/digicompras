...
<p>&nbsp;</p>
<form name="form1" method="post" action="calcula_editar_ficha.php">
<p>
</p>
<table width="100%" border="1" bordercolor="#000000">
  <tr>
    <td><div align="center"><strong>
      <font color="#0000FF"><strong><? echo $codigo_ficha; ?></strong></font>
      <input name="codigo_ficha" type="hidden" id="codigo_ficha" value="<? echo $codigo_ficha; ?>">
      FICHA DE PRODU&Ccedil;&Atilde;O - EDI&Ccedil;&Atilde;O</strong></div></td>
  </tr>
</table><p>
<table width="100%" border="1" bordercolor="#000000">
  <tr>
...
?>
    ...
    <td><div align="center" class="style2">
      <strong><font color="#0000FF"><strong>
...
<p>Observa&ccedil;&otilde;es <br>
  <textarea name="obs" id="obs" cols="70" rows="7"><? echo $obs; ?></textarea>
  <?
$usuario = $_SESSION['usuario'];
$senha = $_SESSION['senha'];
?>
  <input type="submit" name="Submit" value="Re-Calcular Ficha">
