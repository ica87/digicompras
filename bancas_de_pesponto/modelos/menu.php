...
?>
        <input type="submit" name="Submit5" value="Excluir Modelo">
      </form></td>
    </tr>
    <tr>
...
?>
        ...
        <input type="submit" name="Submit4" value="Listar Modelo">
  ...
  <table width="100%" border="0">
    <tr>
      ...
      <td width="12%"><form name="form6" method="post" action="modelos.php">
        ...
        <input name="nfantasia" type="hidden" id="nfantasia" value="<? echo $cliente; ?>">
    ...
    <tr>
      <td><div align="center"><font color="#0000FF"><strong><? echo $cliente; ?></strong></font></div></td>
...
$sql = "select * from modelos where nivel_dificuldade = '$nivel_dificuldade' order by preco_pespontador desc";
...
?>
  ...
  <table width="100%" border="0">
    <tr>
      <td width="17%"><div align="center"></div></td>
      <td width="17%"><div align="center"><strong><font color="#0000FF">Nivel Pesquisado</font></strong></div></td>
      <td width="12%"><form name="form6" method="post" action="modelos.php">
          <strong><font color="#0000FF"><? echo $nivel_dificuldade; ?></font></strong>
          <input name="codigo" type="hidden" id="codigo" value="<? echo $codigo; ?>">
          <input name="nfantasia" type="hidden" id="nfantasia" value="<? echo $cliente; ?>">
          <input type="submit" name="button3" id="button3" value="Editar">
      </form></td>
      <td width="13%">&nbsp;</td>
      <td width="15%">&nbsp;</td>
      <td width="17%">&nbsp;</td>
