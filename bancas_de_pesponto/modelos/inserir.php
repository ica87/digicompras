...
?></td>
    ...
    <tr>
      <td><strong><font color="#0000FF">Cliente</font></strong></td>
      <td><select name="nfantasia" id="nivel_dificuldade">
...
?>
    ...
    <tr> 
      ...
      <td width="13%"><select name="modelo" id="nfantasia">
        <option value="null" selected>
        <?
  ...
  echo "<option>".$x['referencia']."</option>";
...
?>
    ...
    <tr>
      <td colspan="3"><font color="#0000FF"><strong>Travar modelo para n&atilde;o ser distribuido em final de per&iacute;odo?</strong></font></td>
      <td><select name="trava" id="trava">
...
$sql = "select * from modelos order by nfantasia,modelo asc";
