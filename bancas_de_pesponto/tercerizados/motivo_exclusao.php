...
$sql = "SELECT * FROM terceirizados where nome = '$nome'";
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <td colspan="2"><strong><font color="#FF0000">Aten&ccedil;&atilde;o!!..Voc&ecirc; est&aacute; prestes a excluir o cadastro do funcion&aacute;rio abaixo!</font></strong></td>
...
?>
        ...
        <input type="submit" name="Submit" value="Excluir cadastro do Terceirizado"> 
