...
?>
    ...
    <tr>
      ...
      <td width="77%"><strong><font color="#0000FF" size="4">O que deseja fazer com os TERCERIZADOS?</font></strong></td>
...
?>
        ...
        <input type="submit" name="Submit2" value="Cadastrar Tercerizado">
...
?>
        ...
        <input type="submit" name="Submit3" value="Editar Tercerizado">
...
?>
        ...
        <input type="submit" name="button" id="button" value="Excluir Tercerizado">
      </form></td>
