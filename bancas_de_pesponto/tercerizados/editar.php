...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      <select name="bloqueio_parcial" id="bloqueio_parcial">
    ...
    $sql = "select * from grupos_terceirizados order by grupo asc";
...
?>
        ...
        <input type="submit" name="Submit" value="Alterar dados do Terceirizado"> 
