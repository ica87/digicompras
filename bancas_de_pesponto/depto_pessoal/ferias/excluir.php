...
$comando = "delete from `ferias` where `ferias`. `codigo` = '$codigo_a_excluir' limit 1 ";
...
?>
    ...
    $sql = "select * from ferias where dia <> '' group by dia order by dia asc";
...
?>
    ...
    $sql = "select * from ferias where mes <> '' group by mes order by mes desc";
...
?>
    ...
    $sql = "select * from ferias where ano <> '' group by ano order by ano desc";
...
<select name="dia_final" id="select11">
  <?
    ...
    $sql = "select * from ferias group by dia order by dia desc";
...
<select name="mes_final" id="select12">
  <?
    ...
    $sql = "select * from ferias group by mes order by mes desc";
...
<select name="ano_final" id="select13">
  <?
    ...
    $sql = "select * from ferias group by ano order by ano desc";
...
<form name="form1" method="post" action="excluir.php">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="14%"><div align="center">Data da ferias</div></td>
      <td width="15%"><div align="center">REF</div></td>
      <td width="12%"><div align="center">FERIAS</div></td>
      <td width="13%"><div align="center">TERCO</div></td>
      <td width="11%"><div align="center">TOTAL</div></td>
      <td width="11%"><div align="center">SALARIO</div></td>
    </tr>
    <?
...
$sql = "SELECT * FROM ferias where nome = '$nome' and data between '$data_inicial' and '$data_final'";
...
?>
      ...
      <td><div align="center">
        <select name="ref" id="ref">
          <option selected><? echo $ref; ?></option>
          <option>1</option>
          <option>2</option>
          <option>3</option>
          <option>4</option>
      ...
      <td><div align="center"><? echo $ferias; ?></div></td>
      <td><div align="center"><? echo $terco; ?></div></td>
      <td><div align="center"><? echo $ferias_mais_terco; ?></div></td>
