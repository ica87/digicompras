...
$comando = "delete from `bonus` where `bonus`. `codigo` = '$codigo_a_excluir' limit 1 ";



mysql_query($comando,$conexao) or die("Erro ao excluir registro de bonus do funcionario $nome"); 
...
?>
    ...
    $sql = "select * from bonus where dia <> '' group by dia order by dia asc";
...
?>
    ...
    $sql = "select * from bonus where mes <> '' group by mes order by mes desc";
...
?>
    ...
    $sql = "select * from bonus where ano <> '' group by ano order by ano desc";
...
<select name="dia_final" id="select11">
  <?
    ...
    $sql = "select * from bonus group by dia order by dia desc";
...
<select name="mes_final" id="select12">
  <?
    ...
    $sql = "select * from bonus group by mes order by mes desc";
...
<select name="ano_final" id="select13">
  <?
    ...
    $sql = "select * from bonus group by ano order by ano desc";
...
$sql = "SELECT * FROM bonus where nome = '$nome' and data between '$data_inicial' and '$data_final'";
