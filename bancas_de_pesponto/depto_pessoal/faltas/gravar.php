...
$quant_horas_decimais_limitacao_de_horas = "$total_horas.$total_decimal_minutos";

if($quant_horas_decimais_limitacao_de_horas>="8.8"){

$quant_horas_decimais = "8.8";
...
$total = bcmul($quant_horas_decimais,$valor_hora_normal,2);


//-------AQUI COMEÇA CALCULAR DOMINGO----------------
...
$descontar_domingo = "7.33";

$total_domingo = bcmul($descontar_domingo,$valor_hora_normal,2);

}
else{

$descontar_domingo = "0.00";
...
//--------AQUI TERMINA O CALCULO DO DOMINGO-----------


$comando = "insert into faltas(data,dia,mes,ano,hora_inicio,hora_termino,hi,mi,si,ht,mt,st,nome,quant_horas_reais,quant_horas,valor_hora_normal,valor_hora_extra,total,acrescimo,salario,descontar_domingo,total_domingo)

values('$data','$dia','$mes','$ano','$hora_inicio','$hora_termino','$hi','$mi','$si','$ht','$mt','$st','$nome','$quant_horas_reais','$quant_horas_decimais','$valor_hora_normal','$valor_hora_extra','$total','$acrecimo_hora_extra','$salario','$descontar_domingo','$total_domingo')";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div align="center">Descontar Domingo</div></td>
    <td><div align="center"><? echo $descontar_domingo; ?></div></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
