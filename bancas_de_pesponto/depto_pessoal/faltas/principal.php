...
?>
          <input type="submit" name="Submit11" value="Lan&ccedil;amentos FALTAS">
        </div>
      </form>
    </div></td>
    <td width="4%"><div align="center"></div></td>
...
?>
          <input type="submit" name="Submit8" value="Edi&ccedil;&atilde;o FALTAS">
        </div>
      </form>
    </div></td>
...
?>
          <input type="submit" name="Submit15" value="Exclus&atilde;o FALTAS">
        </div>
      </form>
    </div></td>
