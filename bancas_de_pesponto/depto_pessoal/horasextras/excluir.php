...
$comando = "delete from `horas_extras` where `horas_extras`. `codigo` = '$codigo_a_excluir' limit 1 ";



mysql_query($comando,$conexao) or die("Erro ao excluir registro de hora extra do funcionario"); 
...
<form name="form1" method="post" action="excluir.php">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="13%"><div align="center">Total H trab naturais</div></td>
