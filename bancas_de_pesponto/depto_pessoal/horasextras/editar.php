...
?>
    ...
    $sql = "select * from horas_extras where dia <> '' group by dia order by dia asc";
...
<select name="dia_final" id="select11">
  <?
    ...
    $sql = "select * from horas_extras group by dia order by dia desc";
...
?>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="14%"><div align="center">Funcionário</div></td>
      <td width="7%"><div align="center">Nº Lançamento</div></td>
      <td width="7%"><div align="center"></div></td>
      <td width="14%"><div align="center">Data da H.E.</div></td>
      <td width="9%"><div align="center">Hora Inicio</div></td>
      <td width="9%"><div align="center">Hora Término</div></td>
      <td width="5%" align="center">Feriado?</td>
      <td width="10%"><div align="center">Total H trab naturais</div></td>
      <td width="9%"><div align="center">Total H trab decimais</div></td>
      <td width="7%"><div align="center">Total</div></td>
      <td width="9%"><div align="center">Salario</div></td>
    </tr>
    <?
...
$sql = "SELECT * FROM horas_extras where nome = '$nome' and data between '$data_inicial' and '$data_final'";
...
?>
      ...
      <td align="center"><select name="feriado" id="feriado">
        <option>Sim</option>
        <option>Não</option>
        <option selected><? echo $feriado; ?></option>
      </select></td>
