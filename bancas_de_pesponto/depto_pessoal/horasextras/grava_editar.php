...
$percentual_de_horaextra = "1";	
	
	
}
else{
	
$percentual_de_horaextra = "0.5";	
	
}



$acrecimo_hora_extra = bcmul($valor_hora_normal,$percentual_de_horaextra,5);
...
$subtotal2 = bcmul($subtotal,$percentual_de_horaextra,5);
