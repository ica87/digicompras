...
$comando = "insert into vales(data,dia,mes,ano,valor_vale,nome,obs)

values('$data','$dia','$mes','$ano','$valor_vale','$nome','$obs')";

mysql_query($comando,$conexao) or die("Erro ao gravar registro de vale do funcionario no sistema!");

echo "Registro de vale do funcionario $nome gravado com sucesso!<br><br>";
