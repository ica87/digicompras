   ...
   (Sujeito a an&aacute;lise) </strong></font></p>        </td>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $num_pedido; ?>
        <input name="num_pedido" type="hidden" id="num_pedido" value="<? echo $num_pedido; ?>">
      </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td width="15%">Nome/Raz&atilde;o Social:</td>
      <td width="37%"><font color="#000000"><strong><? echo $razaosocial; ?></strong>
        <input name="razaosocial" type="hidden" id="razaosocial" value="<? echo $razaosocial; ?>"> 
      </font></td><td width="11%"><font color="#000000">Cnpj / CPF:</font></td>
      <td width="36%"><font color="#000000">
        <strong><? echo $cnpj; ?></strong>
    ...
    <tr> 
      ...
      <td><font color="#000000">
        <strong><? echo $nfantasia; ?></strong>
        <input name="nfantasia" type="hidden" id="nfantasia" value="<? echo $nfantasia; ?>">      
      </font></td><td><font color="#000000">Inscr. Est: / RG:</font></td>
      <td><font color="#000000"><strong><? echo $inscr_est; ?></strong>
        <input name="inscr_est" type="hidden" id="inscr_est" value="<? echo $inscr_est; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Endere&ccedil;o:</td>
      <td><font color="#000000"><strong><? echo $endereco; ?></strong>
        <input name="endereco" type="hidden" id="endereco" value="<? echo $endereco; ?>">      
      </font></td><td><font color="#000000">N&uacute;mero:</font></td>
      <td><font color="#000000"><strong><? echo $numero; ?></strong>
        <input name="numero" type="hidden" id="numero2" value="<? echo $numero; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td><p>Bairro:</p></td>
      <td><font color="#000000"><strong><? echo $bairro; ?></strong>
        <input name="bairro" type="hidden" id="bairro" value="<? echo $bairro;?>">      
      </font></td><td><font color="#000000">Cidade:</font></td>
      <td><font color="#000000"><strong><? echo $cidade; ?></strong>
        <input name="cidade" type="hidden" id="cidade3" value="<? echo $cidade; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Estado:</td>
      <td><font color="#000000"><strong><? echo $estado; ?></strong>
        <input name="estado" type="hidden" id="estado" value="<? echo $estado; ?>"> 
      </font></td>
      <td><font color="#000000">Cep:</font></td>
      <td><font color="#000000"><strong><? echo $cep; ?></strong>
        <input name="cep" type="hidden" id="cep2" value="<? echo $cep; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td>E-Mail:</td>
      <td><font color="#000000"><strong><? echo $email; ?></strong>
        <input name="email" type="hidden" id="email3" value="<? echo $email; ?>">      
      </font></td><td><font color="#000000">Comprador:</font></td>
      <td><font color="#000000"><strong><? echo $comprador; ?></strong>
        <input name="comprador" type="hidden" id="comprador2" value="<? echo $comprador; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Fone:</td>
      <td><font color="#000000"><strong><? echo $fone; ?></strong>
        <input name="fone" type="hidden" id="fone2" value="<? echo $fone; ?>">      
      </font></td><td><font color="#000000">Fax:</font></td>
      <td><font color="#000000"><strong><? echo $fax; ?></strong>
        <input name="fax" type="hidden" id="fax3" value="<? echo $fax; ?>">      
      </font></td><td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Celular:</td>
      <td><font color="#000000"><strong><? echo $celular; ?></strong>
    ...
    <tr> 
      <td>Cond Pagto:</td>
      <td><font color="#000000">
      <strong><? echo $condpagto; ?></strong>
      <input name="condpagto" type="hidden" id="condpagto" value="<? echo $condpagto; ?>">
      * (sujeito a an&aacute;lise)</font></td>
      <td>Modo Pagto:</td>
      <td><font color="#000000">
      <strong><? echo $modopagto; ?></strong>
      <input name="modopagto" type="hidden" id="celular4" value="<? echo $modopagto;  ?>">
      * (sujeito a an&aacute;lise) </font></td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
...
?>
  ...
  <table width="100%"  border="1">
    <tr>
      ...
      <td width="5%"><div align="center"><font color="#000000"><strong>R$ Unit </strong></font></div></td>
      <td width="3%"><div align="center"><font color="#000000"><strong>Total R$</strong></font></div></td>
    </tr>
    <tr>
...
?>
    ...
    <tr>
      ...
      <td colspan="31">        <?  echo $obs;  ?>        <input name="obs" type="hidden" id="obs" value="<? echo $obs; ?>">      </td>
    </tr>
  </table>
  <p>
  <?
