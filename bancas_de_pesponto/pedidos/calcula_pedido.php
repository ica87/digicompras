...
<form name="form1" method="post" action="grava_pedido.php">
<?
...
(Sujeito a an&aacute;lise)              </font></strong></p>        </td>
    ...
    <tr> 
      <td>&nbsp;</td>
      <td><strong><font color="#0000FF">Seu c&oacute;digo &eacute; </font><font color="#0000FF">: <? echo $cod_cli; ?>
    ...
    <tr> 
      ...
      <td width="37%"><strong><font color="#0000FF"><? echo $razaosocial; ?></font></strong>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $inscr_est; ?></font></strong>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $comprador; ?></font></strong>
    ...
    <tr> 
      ...
      <td><strong><font color="#0000FF"><? echo $fax; ?></font></strong>
    ...
    <tr> 
      ...
      <td>Representante:</td>
      <td><strong><font color="#0000FF"><? echo $representante; ?></font></strong>        <input name="representante" type="hidden" id="representante" value="<? echo $representante; ?>"> </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
      <td>Cond Pagto:</td>
...
?>
    ...
    <tr> 
      ...
      <td>Resdespacho:</td>
      <td><input name="redespacho" type="text" id="redespacho3" value="<? echo $redespacho; ?>" size="50" maxlength="50"> 
...
<input name="total_pares_1" type="hidden" id="quant_111" value="<? echo $soma1; ?>">
      ...
      <td><div align="center">
          <?  
$sql = "SELECT * FROM produtos where referencia = '$referencia_1'";
$res = mysql_query($sql);
...
?> 
          <input name="preco_1" type="hidden" id="preco_1" value="
<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_1'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais1_s1 = bcmul($soma1,$linha[12],2);
echo $total_reais1_s1;
}
else {
$total_reais1_s2 = bcmul($soma1,$linha[10],2);
echo $total_reais1_s2;
...
?>
		  ...
		  <input name="total_reais_1" type="hidden" id="quant_111" value="<? if($linha[11]=="Sim"){
echo $total_reais1_s1;
}
else {
echo $total_reais1_s2;
...
echo $soma2;		
      ...
      <td>
        <div align="center">
          <?
$sql = "SELECT * FROM produtos where referencia = '$referencia_2'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
?>
            ...
            <input name="preco_2" type="hidden" id="preco_22" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_2'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais2_s1 = bcmul($soma2,$linha[12],2);
echo $total_reais2_s1;
}
else {
$total_reais2_s2 = bcmul($soma2,$linha[10],2);
echo $total_reais2_s2;
...
?>
        <input name="total_reais_2" type="hidden" id="total_reais_22" value="<? if($linha[11]=="Sim"){
echo $total_reais2_s1;
}
else {
echo $total_reais2_s2;
...
echo $soma3;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_3'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_3" type="hidden" id="preco_3" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_3'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais3_s1 = bcmul($soma3,$linha[12],2);
echo $total_reais3_s1;
}
else {
$total_reais3_s2 = bcmul($soma3,$linha[10],2);
echo $total_reais3_s2;
...
?>
          <input name="total_reais_3" type="hidden" id="total_reais_32" value="<? if($linha[11]=="Sim"){
echo $total_reais3_s1;
}
else {
echo $total_reais3_s2;
...
echo $soma4;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_4'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_4" type="hidden" id="preco_4" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_4'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais4_s1 = bcmul($soma4,$linha[12],2);
echo $total_reais4_s1;
}
else {
$total_reais4_s2 = bcmul($soma4,$linha[10],2);
echo $total_reais4_s2;
...
?>
          <input name="total_reais_4" type="hidden" id="total_reais_42" value="<? if($linha[11]=="Sim"){
echo $total_reais4_s1;
}
else {
echo $total_reais4_s2;
...
echo $soma5;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_5'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_5" type="hidden" id="preco_5" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_5'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais5_s1 = bcmul($soma5,$linha[12],2);
echo $total_reais1_s1;
}
else {
$total_reais5_s2 = bcmul($soma5,$linha[10],2);
echo $total_reais5_s2;
...
?>
          <input name="total_reais_5" type="hidden" id="total_reais_52" value="<? if($linha[11]=="Sim"){
echo $total_reais5_s1;
}
else {
echo $total_reais5_s2;
...
echo $soma6;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_6'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_6" type="hidden" id="preco_6" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_6'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais6_s1 = bcmul($soma6,$linha[12],2);
echo $total_reais6_s1;
}
else {
$total_reais6_s2 = bcmul($soma6,$linha[10],2);
echo $total_reais6_s2;
...
?>
          <input name="total_reais_6" type="hidden" id="total_reais_62" value="<? if($linha[11]=="Sim"){
echo $total_reais6_s1;
}
else {
echo $total_reais6_s2;
...
echo $soma7;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_7'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_7" type="hidden" id="preco_7" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_7'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais7_s1 = bcmul($soma7,$linha[12],2);
echo $total_reais7_s1;
}
else {
$total_reais7_s2 = bcmul($soma7,$linha[10],2);
echo $total_reais7_s2;
...
?>
          <input name="total_reais_7" type="hidden" id="total_reais_72" value="<? if($linha[11]=="Sim"){
echo $total_reais7_s1;
}
else {
echo $total_reais7_s2;
...
echo $soma8;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_8'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_8" type="hidden" id="preco_8" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_8'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais8_s1 = bcmul($soma8,$linha[12],2);
echo $total_reais8_s1;
}
else {
$total_reais8_s2 = bcmul($soma8,$linha[10],2);
echo $total_reais8_s2;
...
?>
          <input name="total_reais_8" type="hidden" id="total_reais_82" value="<? if($linha[11]=="Sim"){
echo $total_reais8_s1;
}
else {
echo $total_reais8_s2;
...
echo $soma9;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_9'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_9" type="hidden" id="preco_9" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_9'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais9_s1 = bcmul($soma9,$linha[12],2);
echo $total_reais9_s1;
}
else {
$total_reais9_s2 = bcmul($soma9,$linha[10],2);
echo $total_reais9_s2;
...
?>
          <input name="total_reais_9" type="hidden" id="total_reais_92" value="<? if($linha[11]=="Sim"){
echo $total_reais9_s1;
}
else {
echo $total_reais9_s2;
...
echo $soma10;		
      ...
      <td>
        <div align="center">
          <?  $sql = "SELECT * FROM produtos where referencia = '$referencia_10'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
echo $linha[10];
 ...
 ?>
          <input name="preco_10" type="hidden" id="preco_10" value="<?
$sql = "SELECT * FROM produtos where referencia = '$referencia_10'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
if($linha[11]=="Sim"){
$total_reais10_s1 = bcmul($soma10,$linha[12],2);
echo $total_reais10_s1;
}
else {
$total_reais10_s2 = bcmul($soma10,$linha[10],2);
echo $total_reais10_s2;
...
?>
          <input name="total_reais_10" type="hidden" id="total_reais_102" value="<? if($linha[11]=="Sim"){
echo $total_reais10_s1;
}
else {
echo $total_reais10_s2;
...
?>
  ...
  <?
$somageral_reais = $total_reais1_s1+$total_reais1_s2+$total_reais2_s1+$total_reais2_s2+$total_reais3_s1+$total_reais3_s2+$total_reais4_s1+$total_reais4_s2+$total_reais5_s1+$total_reais5_s2+$total_reais6_s1+$total_reais6_s2+$total_reais7_s1+$total_reais7_s2+$total_reais8_s1+$total_reais8_s2+$total_reais9_s1+$total_reais9_s2+$total_reais10_s1+$total_reais10_s2;
...
<form name="form2" method="post" action="corrigir_pedido.php">
  <p><strong><font color="#0000FF">
    <input type="submit" name="Submit3" value="Corrigir Pedido">
    <input name="cod_cli" type="hidden" id="cod_cli" value="<? echo $cod_cli; ?>">
    <input name="razaosocial" type="hidden" id="razaosocial22" value="<? echo $razaosocial; ?>">
    <input name="cnpj" type="hidden" id="cnpj22" value="<? echo $cnpj; ?>">
    <input name="nfantasia" type="hidden" id="nfantasia22" value="<? echo $nfantasia; ?>">
    <input name="inscr_est" type="hidden" id="inscr_est23" value="<? echo $inscr_est; ?>">
    <input name="endereco" type="hidden" id="endereco22" value="<? echo $endereco; ?>">
    <input name="numero" type="hidden" id="numero22" value="<? echo $numero; ?>">
    <input name="bairro" type="hidden" id="bairro22" value="<? echo $bairro;?>">
    <input name="cidade" type="hidden" id="cidade" value="<? echo $cidade; ?>">
    <input name="estado" type="hidden" id="estado22" value="<? echo $estado; ?>">
    <input name="cep" type="hidden" id="cep22" value="<? echo $cep; ?>">
    <input name="email" type="hidden" id="email" value="<? echo $email; ?>">
    <input name="comprador" type="hidden" id="comprador22" value="<? echo $comprador; ?>">
    <input name="fone" type="hidden" id="fone22" value="<? echo $fone; ?>">
    <input name="fax" type="hidden" id="fax" value="<? echo $fax; ?>">
    <input name="celular" type="hidden" id="celular" value="<? echo $celular; ?>">
    <input name="representante" type="hidden" id="representante22" value="<? echo $representante; ?>">
    <input name="condpagto" type="hidden" id="representante23" value="<? echo $condpagto; ?>">
    <input name="modopagto" type="hidden" id="condpagto" value="<? echo $modopagto; ?>">
    <input name="transportadora" type="hidden" id="transportadora" value="<? echo $transportadora; ?>">
    <input name="redespacho" type="hidden" id="redespacho2" value="<? echo $redespacho; ?>">
</font></strong></p>
  <p>
    <input name="referencia_1" type="hidden" id="referencia_12" value="<? echo $referencia_1; ?>">
    <input name="material_1" type="hidden" id="material_13" value="<? echo $material_1; ?>">
    <input name="cor_1" type="hidden" id="cor_13" value="<? echo $cor_1; ?>">
    <input name="solado_1" type="hidden" id="solado_13" value="<? echo $solado_1; ?>">
    <input name="n22_1" type="hidden" id="n22_12"  value="<? echo $n22_1; ?>">
    <input name="n23_1" type="hidden" id="n23_12" value="<? echo $n23_1; ?>">
    <input name="n24_1" type="hidden" id="n24_12" value="<? echo $n24_1; ?>">
    <input name="n25_1" type="hidden" id="n25_12" value="<? echo $n25_1; ?>">
    <input name="n26_1" type="hidden" id="n26_12" value="<? echo $n26_1; ?>">
    <input name="n27_1" type="hidden" id="n27_12" value="<? echo $n27_1; ?>">
    <input name="n28_1" type="hidden" id="n28_12" value="<? echo $n28_1; ?>">
    <input name="n29_1" type="hidden" id="n29_12" value="<? echo $n29_1; ?>">
    <input name="n30_1" type="hidden" id="n30_12" value="<? echo $n30_1; ?>">
    <input name="n31_1" type="hidden" id="n31_12" value="<? echo $n31_1; ?>">
    <input name="n32_1" type="hidden" id="n32_12" value="<? echo $n32_1; ?>">
    <input name="n33_1" type="hidden" id="n33_12" value="<? echo $n33_1; ?>">
    <input name="n34_1" type="hidden" id="n34_12" value="<? echo $n34_1; ?>">
    <input name="n35_1" type="hidden" id="n35_12" value="<? echo $n35_1; ?>">
    <input name="n36_1" type="hidden" id="n36_12" value="<? echo $n36_1; ?>">
    <input name="n37_1" type="hidden" id="n37_12" value="<? echo $n37_1; ?>">
    <input name="n38_1" type="hidden" id="n38_12" value="<? echo $n38_1; ?>">
    <input name="n39_1" type="hidden" id="n39_12" value="<? echo $n39_1; ?>">
    <input name="n40_1" type="hidden" id="n40_12" value="<? echo $n40_1; ?>">
    <input name="n41_1" type="hidden" id="n41_12" value="<? echo $n41_1; ?>">
    <input name="n42_1" type="hidden" id="n42_12" value="<? echo $n42_1; ?>">
    <input name="n43_1" type="hidden" id="n43_12" value="<? echo $n43_1; ?>">
    <input name="n44_1" type="hidden" id="n44_12" value="<? echo $n44_1; ?>">
    <input name="n45_1" type="hidden" id="n45_12" value="<? echo $n45_1; ?>">
    <input name="n46_1" type="hidden" id="n46_12" value="<? echo $n46_1; ?>">
</p>
  <p>
    <input name="referencia_2" type="hidden" id="referencia_23" value="<? echo $referencia_2; ?>">
    <input name="material_2" type="hidden" id="material_22" value="<? echo $material_2; ?>">
    <input name="cor_2" type="hidden" id="referencia_24" value="<? echo $cor_2; ?>">
    <input name="solado_2" type="hidden" id="solado_22" value="<? echo $solado_2; ?>">
    <input name="n22_2" type="hidden" id="n22_22" value="<? echo $n22_2; ?>">
    <input name="n23_2" type="hidden" id="n23_22" value="<? echo $n23_2; ?>">
    <input name="n24_2" type="hidden" id="n24_22" value="<? echo $n24_2; ?>">
    <input name="n25_2" type="hidden" id="n25_22" value="<? echo $n25_2; ?>">
    <input name="n26_2" type="hidden" id="n26_22" value="<? echo $n26_2; ?>">
    <input name="n27_2" type="hidden" id="n27_22" value="<? echo $n27_2; ?>">
    <input name="n28_2" type="hidden" id="n28_22" value="<? echo $n28_2; ?>">
    <input name="n29_2" type="hidden" id="n29_22" value="<? echo $n29_2; ?>">
    <input name="n30_2" type="hidden" id="n30_22" value="<? echo $n30_2; ?>">
    <input name="n31_2" type="hidden" id="n31_22" value="<? echo $n31_2; ?>">
    <input name="n32_2" type="hidden" id="n32_22" value="<? echo $n32_2; ?>">
    <input name="n33_2" type="hidden" id="n33_22" value="<? echo $n33_2; ?>">
    <input name="n34_2" type="hidden" id="n34_22" value="<? echo $n34_2; ?>">
    <input name="n35_2" type="hidden" id="n35_22" value="<? echo $n35_2; ?>">
    <input name="n36_2" type="hidden" id="n36_22" value="<? echo $n36_2; ?>">
    <input name="n37_2" type="hidden" id="n37_22" value="<? echo $n37_2; ?>">
    <input name="n38_2" type="hidden" id="n38_22" value="<? echo $n38_2; ?>">
    <input name="n39_2" type="hidden" id="n39_22" value="<? echo $n39_2; ?>">
    <input name="n40_2" type="hidden" id="n40_22" value="<? echo $n40_2; ?>">
    <input name="n41_2" type="hidden" id="n41_22" value="<? echo $n41_2; ?>">
    <input name="n42_2" type="hidden" id="n42_22" value="<? echo $n42_2; ?>">
    <input name="n43_2" type="hidden" id="n43_22" value="<? echo $n43_2; ?>">
    <input name="n44_2" type="hidden" id="n44_22" value="<? echo $n44_2; ?>">
    <input name="n45_2" type="hidden" id="n45_22" value="<? echo $n45_2; ?>">
    <input name="n46_2" type="hidden" id="n46_22" value="<? echo $n46_2; ?>">
</p>
  <p>
    <input name="referencia_3" type="hidden" id="referencia_32" value="<? echo $referencia_3; ?>">
    <input name="material_3" type="hidden" id="material_32" value="<? echo $material_3; ?>">
    <input name="cor_3" type="hidden" id="cor_32" value="<? echo $cor_3; ?>">
    <input name="solado_3" type="hidden" id="solado_32" value="<? echo $solado_3; ?>">
    <input name="n22_3" type="hidden" id="n22_32" value="<? echo $n22_3; ?>">
    <input name="n23_3" type="hidden" id="n23_32" value="<? echo $n23_3; ?>">
    <input name="n24_3" type="hidden" id="n24_32" value="<? echo $n24_3; ?>">
    <input name="n25_3" type="hidden" id="n25_32" value="<? echo $n25_3; ?>">
    <input name="n26_3" type="hidden" id="n26_32" value="<? echo $n26_3; ?>">
    <input name="n27_3" type="hidden" id="n27_32" value="<? echo $n27_3; ?>">
    <input name="n28_3" type="hidden" id="n28_32" value="<? echo $n28_3; ?>">
    <input name="n29_3" type="hidden" id="n29_32" value="<? echo $n29_3; ?>">
    <input name="n30_3" type="hidden" id="n30_32" value="<? echo $n30_3; ?>">
    <input name="n31_3" type="hidden" id="n31_32" value="<? echo $n31_3; ?>">
    <input name="n32_3" type="hidden" id="n32_32" value="<? echo $n32_3; ?>">
    <input name="n33_3" type="hidden" id="n33_32" value="<? echo $n33_3; ?>">
    <input name="n34_3" type="hidden" id="n34_32" value="<? echo $n34_3; ?>">
    <input name="n35_3" type="hidden" id="n35_32" value="<? echo $n35_3; ?>">
    <input name="n36_3" type="hidden" id="n36_32" value="<? echo $n36_3; ?>">
    <input name="n37_3" type="hidden" id="n37_32" value="<? echo $n37_3; ?>">
    <input name="n38_3" type="hidden" id="n38_32" value="<? echo $n38_3; ?>">
    <input name="n39_3" type="hidden" id="n39_32" value="<? echo $n39_3; ?>">
    <input name="n40_3" type="hidden" id="n40_32" value="<? echo $n40_3; ?>">
    <input name="n41_3" type="hidden" id="n41_32" value="<? echo $n41_3; ?>">
    <input name="n42_3" type="hidden" id="n42_32" value="<? echo $n42_3; ?>">
    <input name="n43_3" type="hidden" id="n43_32" value="<? echo $n43_3; ?>">
    <input name="n44_3" type="hidden" id="n44_32" value="<? echo $n44_3; ?>">
    <input name="n45_3" type="hidden" id="n45_32" value="<? echo $n45_3; ?>">
    <input name="n46_3" type="hidden" id="n46_32" value="<? echo $n46_3; ?>">
</p>
  <p>
    <input name="referencia_4" type="hidden" id="referencia_42" value="<? echo $referencia_4; ?>">
    <input name="material_4" type="hidden" id="material_42" value="<? echo $material_4; ?>">
    <input name="cor_4" type="hidden" id="cor_42" value="<? echo $cor_4; ?>">
    <input name="solado_4" type="hidden" id="solado_42" value="<? echo $solado_4; ?>">
    <input name="n22_4" type="hidden" id="n22_42" value="<? echo $n22_4; ?>">
    <input name="n23_4" type="hidden" id="n23_42" value="<? echo $n23_4; ?>">
    <input name="n24_4" type="hidden" id="n24_42" value="<? echo $n24_4; ?>">
    <input name="n25_4" type="hidden" id="n25_42" value="<? echo $n25_4; ?>">
    <input name="n26_4" type="hidden" id="n26_42" value="<? echo $n26_4; ?>">
    <input name="n27_4" type="hidden" id="n27_42" value="<? echo $n27_4; ?>">
    <input name="n28_4" type="hidden" id="n28_42" value="<? echo $n28_4; ?>">
    <input name="n29_4" type="hidden" id="n29_42" value="<? echo $n29_4; ?>">
    <input name="n30_4" type="hidden" id="n30_42" value="<? echo $n30_4; ?>">
    <input name="n31_4" type="hidden" id="n31_42" value="<? echo $n31_4; ?>">
    <input name="n32_4" type="hidden" id="n32_42" value="<? echo $n32_4; ?>">
    <input name="n33_4" type="hidden" id="n33_42" value="<? echo $n33_4; ?>">
    <input name="n34_4" type="hidden" id="n34_42" value="<? echo $n34_4; ?>">
    <input name="n35_4" type="hidden" id="n35_42" value="<? echo $n35_4; ?>">
    <input name="n36_4" type="hidden" id="n36_42" value="<? echo $n36_4; ?>">
    <input name="n37_4" type="hidden" id="n37_42" value="<? echo $n37_4; ?>">
    <input name="n38_4" type="hidden" id="n38_42" value="<? echo $n38_4; ?>">
    <input name="n39_4" type="hidden" id="n39_42" value="<? echo $n39_4; ?>">
    <input name="n40_4" type="hidden" id="n40_42" value="<? echo $n40_4; ?>">
    <input name="n41_4" type="hidden" id="n41_42" value="<? echo $n41_4; ?>">
    <input name="n42_4" type="hidden" id="n42_42" value="<? echo $n42_4; ?>">
    <input name="n43_4" type="hidden" id="n43_42" value="<? echo $n43_4; ?>">
    <input name="n44_4" type="hidden" id="n44_42" value="<? echo $n44_4; ?>">
    <input name="n45_4" type="hidden" id="n45_42" value="<? echo $n45_4; ?>">
    <input name="n46_4" type="hidden" id="n46_42" value="<? echo $n46_4; ?>">
</p>
  <p>
    <input name="referencia_5" type="hidden" id="referencia_52" value="<? echo $referencia_5; ?>">
    <input name="material_5" type="hidden" id="material_52" value="<? echo $material_5; ?>">
    <input name="cor_5" type="hidden" id="cor_52" value="<? echo $cor_5; ?>">
    <input name="solado_5" type="hidden" id="solado_52" value="<? echo $solado_5; ?>">
    <input name="n22_5" type="hidden" id="n22_52" value="<? echo $n22_5; ?>">
    <input name="n23_5" type="hidden" id="n23_52" value="<? echo $n23_5; ?>">
    <input name="n24_5" type="hidden" id="n24_52" value="<? echo $n24_5; ?>">
    <input name="n25_5" type="hidden" id="n25_52" value="<? echo $n25_5; ?>">
    <input name="n26_5" type="hidden" id="n26_52" value="<? echo $n26_5; ?>">
    <input name="n27_5" type="hidden" id="n27_52" value="<? echo $n27_5; ?>">
    <input name="n28_5" type="hidden" id="n28_52" value="<? echo $n28_5; ?>">
    <input name="n29_5" type="hidden" id="n29_52" value="<? echo $n29_5; ?>">
    <input name="n30_5" type="hidden" id="n30_52" value="<? echo $n30_5; ?>">
    <input name="n31_5" type="hidden" id="n31_52" value="<? echo $n31_5; ?>">
    <input name="n32_5" type="hidden" id="n32_52" value="<? echo $n32_5; ?>">
    <input name="n33_5" type="hidden" id="n33_52" value="<? echo $n33_5; ?>">
    <input name="n34_5" type="hidden" id="n34_52" value="<? echo $n34_5; ?>">
    <input name="n35_5" type="hidden" id="n35_52" value="<? echo $n35_5; ?>">
    <input name="n36_5" type="hidden" id="n36_52" value="<? echo $n36_5; ?>">
    <input name="n37_5" type="hidden" id="n37_52" value="<? echo $n37_5; ?>">
    <input name="n38_5" type="hidden" id="n38_52" value="<? echo $n38_5; ?>">
    <input name="n39_5" type="hidden" id="n39_52" value="<? echo $n39_5; ?>">
    <input name="n40_5" type="hidden" id="n40_52" value="<? echo $n40_5; ?>">
    <input name="n41_5" type="hidden" id="n41_52" value="<? echo $n41_5; ?>">
    <input name="n42_5" type="hidden" id="n42_52" value="<? echo $n42_5; ?>">
    <input name="n43_5" type="hidden" id="n43_52" value="<? echo $n43_5; ?>">
    <input name="n44_5" type="hidden" id="n44_52" value="<? echo $n44_5; ?>">
    <input name="n45_5" type="hidden" id="n45_52" value="<? echo $n45_5; ?>">
    <input name="n46_5" type="hidden" id="n46_52" value="<? echo $n46_5; ?>">
</p>
  <p>
    <input name="referencia_6" type="hidden" id="referencia_62" value="<? echo $referencia_6; ?>">
    <input name="material_6" type="hidden" id="material_62" value="<? echo $material_6; ?>">
    <input name="cor_6" type="hidden" id="cor_62" value="<? echo $cor_6; ?>">
    <input name="solado_6" type="hidden" id="solado_62" value="<? echo $solado_6; ?>">
    <input name="n22_6" type="hidden" id="n22_62" value="<? echo $n22_6; ?>">
    <input name="n23_6" type="hidden" id="n23_62" value="<? echo $n23_6; ?>">
    <input name="n24_6" type="hidden" id="n24_62" value="<? echo $n24_6; ?>">
    <input name="n25_6" type="hidden" id="n25_62" value="<? echo $n25_6; ?>">
    <input name="n26_6" type="hidden" id="n26_62" value="<? echo $n26_6; ?>">
    <input name="n27_6" type="hidden" id="n27_62" value="<? echo $n27_6; ?>">
    <input name="n28_6" type="hidden" id="n28_62" value="<? echo $n28_6; ?>">
    <input name="n29_6" type="hidden" id="n29_62" value="<? echo $n29_6; ?>">
    <input name="n30_6" type="hidden" id="n30_62" value="<? echo $n30_6; ?>">
    <input name="n31_6" type="hidden" id="n31_62" value="<? echo $n31_6; ?>">
    <input name="n32_6" type="hidden" id="n32_62" value="<? echo $n32_6; ?>">
    <input name="n33_6" type="hidden" id="n33_62" value="<? echo $n33_6; ?>">
    <input name="n34_6" type="hidden" id="n34_62" value="<? echo $n34_6; ?>">
    <input name="n35_6" type="hidden" id="n35_62" value="<? echo $n35_6; ?>">
    <input name="n36_6" type="hidden" id="n36_62" value="<? echo $n36_6; ?>">
    <input name="n37_6" type="hidden" id="n37_62" value="<? echo $n37_6; ?>">
    <input name="n38_6" type="hidden" id="n38_62" value="<? echo $n38_6; ?>">
    <input name="n39_6" type="hidden" id="n39_62" value="<? echo $n39_6; ?>">
    <input name="n40_6" type="hidden" id="n40_62" value="<? echo $n40_6; ?>">
    <input name="n41_6" type="hidden" id="n41_62" value="<? echo $n41_6; ?>">
    <input name="n42_6" type="hidden" id="n42_62" value="<? echo $n42_6; ?>">
    <input name="n43_6" type="hidden" id="n43_62" value="<? echo $n43_6; ?>">
    <input name="n44_6" type="hidden" id="n44_62" value="<? echo $n44_6; ?>">
    <input name="n45_6" type="hidden" id="n45_62" value="<? echo $n45_6; ?>">
    <input name="n46_6" type="hidden" id="n46_62" value="<? echo $n46_6; ?>">
</p>
  <p>
    <input name="referencia_7" type="hidden" id="referencia_72" value="<? echo $referencia_7; ?>">
    <input name="material_7" type="hidden" id="material_72" value="<? echo $material_7; ?>">
    <input name="cor_7" type="hidden" id="cor_72" value="<? echo $cor_7; ?>">
    <input name="solado_7" type="hidden" id="solado_72" value="<? echo $solado_7; ?>">
    <input name="n22_7" type="hidden" id="n22_72" value="<? echo $n22_7; ?>">
    <input name="n23_7" type="hidden" id="n23_72" value="<? echo $n23_7; ?>">
    <input name="n24_7" type="hidden" id="n24_72" value="<? echo $n24_7; ?>">
    <input name="n25_7" type="hidden" id="n25_72" value="<? echo $n25_7; ?>">
    <input name="n26_7" type="hidden" id="n26_72" value="<? echo $n26_7; ?>">
    <input name="n27_7" type="hidden" id="n27_72" value="<? echo $n27_7; ?>">
    <input name="n28_7" type="hidden" id="n28_72" value="<? echo $n28_7; ?>">
    <input name="n29_7" type="hidden" id="n29_72" value="<? echo $n29_7; ?>">
    <input name="n30_7" type="hidden" id="n30_72" value="<? echo $n30_7; ?>">
    <input name="n31_7" type="hidden" id="n31_72" value="<? echo $n31_7; ?>">
    <input name="n32_7" type="hidden" id="n32_72" value="<? echo $n32_7; ?>">
    <input name="n33_7" type="hidden" id="n33_72" value="<? echo $n33_7; ?>">
    <input name="n34_7" type="hidden" id="n34_72" value="<? echo $n34_7; ?>">
    <input name="n35_7" type="hidden" id="n35_72" value="<? echo $n35_7; ?>">
    <input name="n36_7" type="hidden" id="n36_72" value="<? echo $n36_7; ?>">
    <input name="n37_7" type="hidden" id="n37_72" value="<? echo $n37_7; ?>">
    <input name="n38_7" type="hidden" id="n38_72" value="<? echo $n38_7; ?>">
    <input name="n39_7" type="hidden" id="n39_72" value="<? echo $n39_7; ?>">
    <input name="n40_7" type="hidden" id="n40_72" value="<? echo $n40_7; ?>">
    <input name="n41_7" type="hidden" id="n41_72" value="<? echo $n41_7; ?>">
    <input name="n42_7" type="hidden" id="n42_72" value="<? echo $n42_7; ?>">
    <input name="n43_7" type="hidden" id="n43_72" value="<? echo $n43_7; ?>">
    <input name="n44_7" type="hidden" id="n44_72" value="<? echo $n44_7; ?>">
    <input name="n45_7" type="hidden" id="n45_72" value="<? echo $n45_7; ?>">
    <input name="n46_7" type="hidden" id="n46_72" value="<? echo $n46_7; ?>">
  </p>
  <p>
    <input name="referencia_8" type="hidden" id="referencia_8" value="<? echo $referencia_8; ?>">
                  <input name="material_8" type="hidden" id="material_8" value="<? echo $material_8; ?>">
                  ...
                  <input name="solado_8" type="hidden" id="solado_8" value="<? echo $solado_8; ?>">
            <input name="n22_8" type="hidden" id="n22_8" value="<? echo $n22_8; ?>">
            <input name="n23_8" type="hidden" id="n23_8" value="<? echo $n23_8; ?>">
            <input name="n24_8" type="hidden" id="n24_8" value="<? echo $n24_8; ?>">
            <input name="n25_8" type="hidden" id="n25_8" value="<? echo $n25_8; ?>">
            <input name="n26_8" type="hidden" id="n26_8" value="<? echo $n26_8; ?>">
            <input name="n27_8" type="hidden" id="n27_8" value="<? echo $n27_8; ?>">
            <input name="n28_8" type="hidden" id="n28_8" value="<? echo $n28_8; ?>">
            <input name="n29_8" type="hidden" id="n29_8" value="<? echo $n29_8; ?>">
            <input name="n30_8" type="hidden" id="n30_8" value="<? echo $n30_8; ?>">
            <input name="n31_8" type="hidden" id="n31_8" value="<? echo $n31_8; ?>">
            <input name="n32_8" type="hidden" id="n32_8" value="<? echo $n32_8; ?>">
            <input name="n33_8" type="hidden" id="n33_8" value="<? echo $n33_8; ?>">
            <input name="n34_8" type="hidden" id="n34_8" value="<? echo $n34_8; ?>">
            <input name="n35_8" type="hidden" id="n35_8" value="<? echo $n35_8; ?>">
            <input name="n36_8" type="hidden" id="n36_8" value="<? echo $n36_8; ?>">
            <input name="n37_8" type="hidden" id="n37_8" value="<? echo $n37_8; ?>">
            <input name="n38_8" type="hidden" id="n38_8" value="<? echo $n38_8; ?>">
            <input name="n39_8" type="hidden" id="n39_8" value="<? echo $n39_8; ?>">
            <input name="n40_8" type="hidden" id="n40_8" value="<? echo $n40_8; ?>">
            <input name="n41_8" type="hidden" id="n41_8" value="<? echo $n41_8; ?>">
            <input name="n42_8" type="hidden" id="n42_8" value="<? echo $n42_8; ?>">
            <input name="n43_8" type="hidden" id="n43_8" value="<? echo $n43_8; ?>">
            <input name="n44_8" type="hidden" id="n44_8" value="<? echo $n44_8; ?>">
            <input name="n45_8" type="hidden" id="n45_8" value="<? echo $n45_8; ?>">
            <input name="n46_8" type="hidden" id="n46_8" value="<? echo $n46_8; ?>">
  </p>
  <p>                  <input name="referencia_9" type="hidden" id="referencia_9" value="<? echo $referencia_9; ?>">
                  <input name="material_9" type="hidden" id="material_9" value="<? echo $material_9; ?>">
                  <input name="cor_9" type="hidden" id="cor_9" value="<? echo $cor_9; ?>">
                  <input name="solado_9" type="hidden" id="solado_9" value="<? echo $solado_9; ?>">
          
            <input name="n22_9" type="hidden" id="n22_9" value="<? echo $n22_9; ?>">
            <input name="n23_9" type="hidden" id="n23_9" value="<? echo $n23_9; ?>">
            <input name="n24_9" type="hidden" id="n24_9" value="<? echo $n24_9; ?>">
            <input name="n25_9" type="hidden" id="n25_9" value="<? echo $n25_9; ?>">
            <input name="n26_9" type="hidden" id="n26_9" value="<? echo $n26_9; ?>">
            <input name="n27_9" type="hidden" id="n27_9" value="<? echo $n27_9; ?>">
            <input name="n28_9" type="hidden" id="n28_9" value="<? echo $n28_9; ?>">
            <input name="n29_9" type="hidden" id="n29_9" value="<? echo $n29_9; ?>">
            <input name="n30_9" type="hidden" id="n30_9" value="<? echo $n30_9; ?>">
            <input name="n31_9" type="hidden" id="n31_9" value="<? echo $n31_9; ?>">
            <input name="n32_9" type="hidden" id="n32_9" value="<? echo $n32_9; ?>">
            <input name="n33_9" type="hidden" id="n33_9" value="<? echo $n33_9; ?>">
            <input name="n34_9" type="hidden" id="n34_9" value="<? echo $n34_9; ?>">
            <input name="n35_9" type="hidden" id="n35_9" value="<? echo $n35_9; ?>">
            <input name="n36_9" type="hidden" id="n36_9" value="<? echo $n36_9; ?>">
            <input name="n37_9" type="hidden" id="n37_9" value="<? echo $n37_9; ?>">
            <input name="n38_9" type="hidden" id="n38_9" value="<? echo $n38_9; ?>">
            <input name="n39_9" type="hidden" id="n39_9" value="<? echo $n39_9; ?>">
            <input name="n40_9" type="hidden" id="n40_9" value="<? echo $n40_9; ?>">
            <input name="n41_9" type="hidden" id="n41_9" value="<? echo $n41_9; ?>">
            <input name="n42_9" type="hidden" id="n42_9" value="<? echo $n42_9; ?>">
            <input name="n43_9" type="hidden" id="n43_9" value="<? echo $n43_9; ?>">
            <input name="n44_9" type="hidden" id="n44_9" value="<? echo $n44_9; ?>">
            <input name="n45_9" type="hidden" id="n45_9" value="<? echo $n45_9; ?>">
            <input name="n46_9" type="hidden" id="n46_9" value="<? echo $n46_9; ?>">
  </p>
  <p>                  <input name="referencia_10" type="hidden" id="referencia_10" value="<? echo $referencia_10; ?>">
                  <input name="material_10" type="hidden" id="material_10" value="<? echo $material_10; ?>">
                  <input name="cor_10" type="hidden" id="cor_10" value="<? echo $cor_10; ?>">
                  <input name="solado_10" type="hidden" id="solado_10" value="<? echo $solado_10; ?>">
            
            <input name="n22_10" type="hidden" id="n22_10" value="<? echo $n22_10; ?>">
            <input name="n23_10" type="hidden" id="n23_10" value="<? echo $n23_10; ?>">
            <input name="n24_10" type="hidden" id="n24_10" value="<? echo $n24_10; ?>">
            <input name="n25_10" type="hidden" id="n25_10" value="<? echo $n25_10; ?>">
            <input name="n26_10" type="hidden" id="n26_10" value="<? echo $n26_10; ?>">
            <input name="n27_10" type="hidden" id="n27_10" value="<? echo $n27_10; ?>">
            <input name="n28_10" type="hidden" id="n28_10" value="<? echo $n28_10; ?>">
            <input name="n29_10" type="hidden" id="n29_10" value="<? echo $n29_10; ?>">
            <input name="n30_10" type="hidden" id="n30_10" value="<? echo $n30_10; ?>">
            <input name="n31_10" type="hidden" id="n31_10" value="<? echo $n31_10; ?>">
            <input name="n32_10" type="hidden" id="n32_10" value="<? echo $n32_10; ?>">
            <input name="n33_10" type="hidden" id="n33_10" value="<? echo $n33_10; ?>">
            <input name="n34_10" type="hidden" id="n34_10" value="<? echo $n34_10; ?>">
            <input name="n35_10" type="hidden" id="n35_10" value="<? echo $n35_10; ?>">
            <input name="n36_10" type="hidden" id="n36_10" value="<? echo $n36_10; ?>">
            <input name="n37_10" type="hidden" id="n37_10" value="<? echo $n37_10; ?>">
            <input name="n38_10" type="hidden" id="n38_10" value="<? echo $n38_10; ?>">
            <input name="n39_10" type="hidden" id="n39_10" value="<? echo $n39_10; ?>">
            <input name="n40_10" type="hidden" id="n40_10" value="<? echo $n40_10; ?>">
            <input name="n41_10" type="hidden" id="n41_10" value="<? echo $n41_10; ?>">
            <input name="n42_10" type="hidden" id="n42_10" value="<? echo $n42_10; ?>">
            <input name="n43_10" type="hidden" id="n43_10" value="<? echo $n43_10; ?>">
            <input name="n44_10" type="hidden" id="n44_10" value="<? echo $n44_10; ?>">
            <input name="n45_10" type="hidden" id="n45_10" value="<? echo $n45_10; ?>">
            <input name="n46_10" type="hidden" id="n46_10" value="<? echo $n46_10; ?>">
  </p>
  <p>        <input name="obs" type="hidden" id="obs" value="<? echo $obs; ?>">
    <?
$_SESSION['usuario'] = $usuario;
$_SESSION['senha'] = $senha;
?>
