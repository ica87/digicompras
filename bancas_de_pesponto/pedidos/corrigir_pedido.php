...
(Sujeito a an&aacute;lise)              </font></strong></p>        </td>
    ...
    <tr>
      ...
      <td width="36%"><strong></strong> <strong><font color="#0000FF"><? echo $cnpj; ?></font></strong>
    ...
    <tr>
      ...
      <td><strong></strong> <strong><font color="#0000FF"><? echo $nfantasia; ?></font></strong>
    ...
    <tr>
      ...
      <td>Representante:</td>
      <td><strong><font color="#0000FF"><? echo $representante; ?></font></strong>
          <input name="representante" type="hidden" id="representante" value="<? echo $representante; ?>">
      </td> 
      <td>&nbsp;</td>
    </tr>
    <tr>
