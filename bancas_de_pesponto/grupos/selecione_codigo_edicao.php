...
<p class="style2">Edi&ccedil;&atilde;o de Grupos </p>
...
<form action="grupos.php" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="100%"  border="0">
    ...
    $sql = "select * from grupos order by codigo";
