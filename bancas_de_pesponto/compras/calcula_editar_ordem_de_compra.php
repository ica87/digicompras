...
//$cidade_estabelecimentov = $_POST['cidade_estabelecimento_alterou'];
//$tel_estabelecimento_alterou = $_POST['tel_estabelecimento_alterou'];
//$email_estabelecimentov = $_POST['email_estabelecimento_alterou'];
...
<p>&nbsp;</p>
<form name="form1" method="post" action="grava_editar_orcamento.php">
<p>
</p>
  ...
  <tr>
    <td><div align="center"><strong>
      <select name="condicao" id="condicao">
        <option selected>OR&Ccedil;AMENTO</option>
        <option>PEDIDO</option>
      </select>
      N &ordm; <font color="#0000FF"><strong><? echo $codigo_ordem; ?></strong></font>    </strong>
        <input name="codigo_ordem" type="hidden" id="codigo_ordem" value="<? echo $codigo_ordem; ?>">
    </div></td>
  </tr>
</table><p>
<table width="100%" border="1" bordercolor="#000000">
  <tr>
    <td><table width="100%" border="0" cellspacing="4">
      <tr>
        ...
        <td><strong><font color="#0000FF"><strong><? echo $comprador_cliente; ?><font color="#0000FF"><strong>
      ...
      <tr>
        ...
        <td><strong><font color="#0000FF"><strong><? echo $razaosocial_cliente; ?><font color="#0000FF"><strong>
          <input name="razaosocial" type="hidden" id="razaosocial" value="<? echo $razaosocial_cliente; ?>">
          <font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong>
          <input name="cnpj" type="hidden" id="cnpj" value="<? echo $cnpj; ?>">
        </strong></font></strong></font></strong></font></strong></font></strong></font></strong></font></strong></font></strong></font></strong></td>
        <td><strong>Celular:</strong></td>
        <td><strong><font color="#0000FF"><strong><? echo $celular_cliente; ?><font color="#0000FF"><strong>
          <input name="celular" type="hidden" id="celular" value="<? echo $celular_cliente; ?>">
        </strong></font></strong></font></strong></td>
      </tr>
      <tr>
        <td><strong>Nome Fantasia:</strong></td>
        <td><strong><font color="#0000FF"><strong><? echo $nfantasia_cliente; ?><font color="#0000FF"><strong>
          <input name="nfantasia2" type="hidden" id="nfantasia2" value="<? echo $nfantasia_cliente; ?>">
        </strong></font></strong></font></strong></td>
        <td><strong>E-Mail:</strong></td>
        <td><strong><font color="#0000FF"><strong><? echo $email_cliente; ?><font color="#0000FF"><strong>
          <input name="email" type="hidden" id="email" value="<? echo $email_cliente; ?>">
        </strong></font></strong></font></strong></td>
      </tr>
      <tr>
        <td width="11%"><strong>Endere&ccedil;o:</strong></td>
        <td width="40%"><strong><font color="#0000FF"><strong><? echo $endereco_cliente; ?> N&ordm; <font color="#0000FF"><strong><? echo $numero_cliente; ?><font color="#0000FF"><strong>
          <input name="endereco" type="hidden" id="endereco" value="<? echo $endereco_cliente; ?>">
          </strong></font><font color="#0000FF"><strong>
          <input name="numero" type="hidden" id="numero" value="<? echo $numero_cliente; ?>">
        </strong></font></strong></font></strong></font></strong></td>
        <td width="13%"><strong>CEP:</strong></td>
        <td width="36%"><strong><font color="#0000FF"><strong><? echo $cep_cliente; ?><font color="#0000FF"><strong>
          <input name="cep" type="hidden" id="cep" value="<? echo $cep_cliente; ?>">
        </strong></font></strong></font></strong></td>
      </tr>
      <tr>
        <td><p><strong>Bairro:</strong></p></td>
        <td><strong><font color="#0000FF"><strong><? echo $bairro_cliente; ?><font color="#0000FF"><strong>
          <input name="bairro" type="hidden" id="bairro" value="<? echo $bairro_cliente; ?>">
        </strong></font></strong></font></strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><strong><font color="#0000FF"><strong><? echo $cidade_cliente; ?> Estado <font color="#0000FF"><strong><? echo $estado_cliente; ?><font color="#0000FF"><strong>
          <input name="cidade" type="hidden" id="cidade" value="<? echo $cidade_cliente; ?>">
          </strong></font><font color="#0000FF"><strong>
          <input name="estado" type="hidden" id="estado" value="<? echo $estado_cliente; ?>">
        </strong></font></strong></font></strong></font></strong></td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        ...
        <td><strong><font color="#0000FF"><strong><? echo $fone_cliente; ?><font color="#0000FF"><strong>
...
<table width="100%" border="1" bordercolor="#000000">
  ...
  <tr>
    ...
    <td width="14%"><strong>PRE&Ccedil;O COMPRA</strong></td>
    <td width="15%"><strong>PRE&Ccedil;O  VENDA</strong></td>
    <td width="12%">&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><strong><font color="#0000FF"><strong><? echo $quant1; ?></strong></font></strong>
      ...
      <input name="preco_compra_1" type="hidden" id="preco_compra_1" value="<? echo $preco_compra_1; ?>"></td>
        <td><strong><font color="#0000FF"><strong>
          <input name="preco1" type="text" id="preco1" value="<? if($preco_um<>$preco1){echo $preco_um; }else{ echo $preco1; } ?>" size="10">
        </strong></font></strong></td>
        <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><strong><font color="#0000FF"><strong><? echo $preco_compra_2; ?></strong></font></strong>
      ...
      <td><input name="preco2" type="text" id="preco2" value="<? if($preco_dois<>$preco2){echo $preco_dois; }else{ echo $preco2; } ?>" size="10"></td>
      <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><strong><font color="#0000FF"><strong><? echo $preco_compra_3; ?></strong></font></strong>
      ...
      <td><input name="preco3" type="text" id="preco3" value="<? if($preco_tres<>$preco3){echo $preco_tres; }else{ echo $preco3; } ?>" size="10"></td>
      <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><strong><font color="#0000FF"><strong><? echo $preco_compra_4; ?></strong></font></strong>
      ...
      <td><input name="preco4" type="text" id="preco4" value="<? if($preco_quatro<>$preco4){echo $preco_quatro; }else{ echo $preco4; } ?>" size="10"></td>
      <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco5" type="text" id="preco5" value="<? if($preco_cinco<>$preco5){echo $preco_cinco; }else{ echo $preco5; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco6" type="text" id="preco6" value="<? if($preco_seis<>$preco6){echo $preco_seis; }else{ echo $preco6; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco7" type="text" id="preco7" value="<? if($preco_sete<>$preco7){echo $preco_sete; }else{ echo $preco7; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco8" type="text" id="preco8" value="<? if($preco_oito<>$preco8){echo $preco_oito; }else{ echo $preco8; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco9" type="text" id="preco9" value="<? if($preco_nove<>$preco9){echo $preco_nove; }else{ echo $preco9; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco10" type="text" id="preco10" value="<? if($preco_dez<>$preco10){echo $preco_dez; }else{ echo $preco10; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco11" type="text" id="preco11" value="<? if($preco_onze<>$preco11){echo $preco_onze; }else{ echo $preco11; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco12" type="text" id="preco12" value="<? if($preco_doze<>$preco12){echo $preco_doze; }else{ echo $preco12; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco13" type="text" id="preco13" value="<? if($preco_treze<>$preco13){echo $preco_treze; }else{ echo $preco13; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco14" type="text" id="preco14" value="<? if($preco_quatorze<>$preco14){echo $preco_quatorze; }else{ echo $preco14; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td><input name="preco15" type="text" id="preco15" value="<? if($preco_quinze<>$preco15){echo $preco_quinze; }else{ echo $preco15; } ?>" size="10"></td>
    <td>&nbsp;</td>
  </tr>
</table>
<br>
...
$senha = $_SESSION['senha'];
?>
  <input type="submit" name="Submit" value="Gravar Edi&ccedil;&atilde;o de Ordem de Compra">
