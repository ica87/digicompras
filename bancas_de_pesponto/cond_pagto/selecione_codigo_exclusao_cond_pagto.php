...
<p class="style2">Exclus&atilde;o de estados </p>
<p><a href="menu.php">Voltar</a></p>
<form action="excluir_cond_pagto.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="45%">Selecione o c&oacute;digo. da condi&ccedil;&atilde;o de pagto a ser exclu&iacute;da<br></td>
      <td width="15%"><select name="codigo" id="select4">
        <option value="null" selected>Selecione
        <?


    $sql = "select * from cond_pagto order by codigo";
...
<span class="style1">Condi&ccedil;&atilde;o:</span> <? printf("$linha[1]<br>"); ?>
