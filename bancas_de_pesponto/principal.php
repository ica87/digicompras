...
$data_termino_producao =  "$ano_termino_producao-$mes_termino_producao-$dia_termino_producao"; //$_POST['data_termino_producao'];
...
?>
      <input type="submit" name="Submit8" value="Bancas">
    </form></td>
    <td><div align="center"><strong>Pesquisa  de Fichas</strong></div></td>
...
?>
     <? if($funcao=="Gerente de Produção"){}else{ echo "<input type='submit' name='Submit20' value='Modelos'>"; }  ?>
    </form></td>
...
?>
  ...
  <tr>
    <td width="3%" height="15"><div align="center" class="style4">Data entrada</div></td>
    <td width="4%"><div align="center" class="style4">N&ordm; Plano</div></td>
    <td width="5%"><div align="center" class="style4">N&ordm; Ficha</div></td>
    <td width="7%"><div align="center" class="style4">Status Produ&ccedil;&atilde;o</div></td>
    <td width="7%"><div align="center"><span class="style4">Status</span></div></td>
    <td width="6%"><div align="center"><span class="style4">Data Envio para f&aacute;brica</span></div></td>
    <td width="3%"><div align="center" class="style4">Quant Pares</div></td>
    <td width="5%"><div align="center" class="style4">N&ordm; Modelo</div></td>
    <td width="7%"><div align="center" class="style4">N&iacute;vel Dificuldade</div></td>
    <td width="5%"><div align="center" class="style4">Metal Entregue?</div></td>
    <td width="4%"><div align="center"><span class="style4">Caixa</span></div></td>
    <td width="3%"><div align="center" class="style4">Grupo</div></td>
    <td width="4%"><div align="center" class="style4">R$ Unit Pesponto</div></td>
    <td width="4%"><div align="center" class="style4">R$ Total Pesponto</div></td>
    <td width="4%"><div align="center" class="style4">R$ Unit Coladeira 1 </div></td>
    <td width="4%"><div align="center" class="style4">R$ Total Coladeira 1 </div></td>
    <td width="4%"><div align="center" class="style4">R$ Unit Coladeira 2</div></td>
    <td width="4%"><div align="center" class="style4">R$ Total Coladeira 2</div></td>
    <td width="4%"><div align="center" class="style4">R$ Total Ficha</div></td>
    <td width="4%"><div align="center" class="style4">R$ Unit Empresa</div></td>
    <td width="4%"><div align="center" class="style4">R$ Total Empresa</div></td>
    <td width="5%"><div align="center"><span class="style4">Saldo</span></div></td>
  </tr>
  <tr>
    ...
    <td><div align="center" class="style2 style2 style4"><strong><font color="#0000FF"><strong><strong><font color="#0000FF"><strong><? echo $num_plano; ?></strong></font></strong></strong></font></strong></div></td>
    ...
    <td><div align="center" class="style2 style2 style4">
      <form name="form3" method="post" action="../fichas/historico_cliente.php">
        ...
        <strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF">
          ...
          </font></strong></font></strong></font></strong></font></strong></font></strong><? echo $status; ?>
        <? //if($status<>"Enviado"){ echo "<input type='submit' name='button' id='button' value='Alterar'>"; } ?>
      </form>
    </div></td>
    <td><div align="center" class="style4">
      <form action="<? if($status=="Enviado" & $funcao=="Administrador"){ echo "fichas/editar_ficha_apos_envio_para_fabrica.php"; 
	  }
	  else{
	  if($metal_entregue=="Sim" & $status<>"Enviado"){ echo "principal.php"; }
...
$senha = $_SESSION['senha'];
?>
          </span> <span class="style5"><strong><strong><? if(empty($dia_envio)){}else{ //echo "$dia_envio-$mes_envio-$ano_envio $hora_envio"; 
		  } ?></strong></strong>
        <input name="codigo_ficha" type="hidden" id="codigo_ficha3" value="<? echo $codigo_ficha; ?>">
            <strong><strong><strong><strong><strong>
              ...
              <input name="num_ficha" type="hidden" id="num_ficha" value="<? echo $num_ficha;  ?>">
              <font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF">
              <input name="status" type="hidden" id="status" value="Enviado">
              </font></strong></font></strong></font></strong></font></strong></font>
...
?>
              </font></strong></font></strong></font></strong></font></strong></font><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF"><strong><font color="#0000FF">
              <?
if($metal_entregue=="Não"){
...
?>
              ...
              </font></strong></font></strong></font></strong></font></strong></font><? if($status=="Enviado" & $funcao=="Administrador"){ echo "<input type='submit' name='button' id='button' value='$dia_envio-$mes_envio-$ano_envio $hora_envio - Editar'>"; 
			  }
			  else{
			  
			  if($metal_entregue=="Sim" & $status<>"Enviado"){ echo "<input type='submit' name='button2' id='button2' value='Enviar p/ Fábrica'>"; }
