...
<p class="style2">Edi&ccedil;&atilde;o de estados </p>
...
<form action="estados.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do estado a ser editado<br></td>
