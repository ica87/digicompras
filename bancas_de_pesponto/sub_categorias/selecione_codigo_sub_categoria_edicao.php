...
<p class="style2">Edi&ccedil;&atilde;o de Sub categorias </p>
<p><a href="menu.php">Voltar</a></p>
<form action="sub_categoria.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo da Sub categoria para edi&ccedil;&atilde;o<br></td>
...
?>
      ...
      <td width="40%"><input type="submit" name="Submit" value="Editar Sub Categoria"></td>
    </tr>
  </table>
</form>
<?
