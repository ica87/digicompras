...
<p class="style2">Altera&ccedil;&atilde;o de categoria relacionada &agrave;Sub categoria</p>
<p><a href="menu.php">Voltar</a></p>
<form action="sub_categoria_alterar_categoria.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="51%">Selecione o c&oacute;digo da Sub categoria para troca de categoria relacionada <br></td>
      <td width="20%"><select name="codigo" id="select4">
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit" value="Trocar categoria relacionada"></td>
      <td>&nbsp;</td>
    </tr>
  </table>
</form>
