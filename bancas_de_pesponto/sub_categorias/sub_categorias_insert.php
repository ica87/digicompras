...
?>
    ...
    <tr>
      <td width="20%">&nbsp;</td>
      <td width="80%"><strong><font color="#0000FF" size="4">Tela de cadastro de Sub Categorias!</font></strong></td>
    </tr>
    <tr>
...
<span class="style1">Pertence à Categoria:</span> <? printf("$linha[2]<br>"); ?>
