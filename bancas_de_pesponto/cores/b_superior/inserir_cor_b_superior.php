...
<p class="style1">Inseir cor pela 1&ordm; vez da barra superior! insira o codigo hexadecimal ex: 0000ff.<br>
   Escolha na tabela abaixo, copie, cole e clique em atualizar
<form action="grava_cor_b_superior.php" method="post" enctype="multipart/form-data" name="form1">
