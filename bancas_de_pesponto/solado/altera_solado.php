...
<p class="style2">Altera&ccedil;&atilde;o de nome de solado. </p>
<p><a href="menu.php">Voltar</a></p>
<form action="autalizar_solado.php" method="post" name="form2">
...
$sql = "SELECT * FROM solados where codigo = '$codigo'";
//EXECUTA O COMANDO ACIMA
$res = mysql_query($sql);
...
?></td>
        ...
        <tr>
          <td height="40">Altere o  nome do solado </td>
          <td><input name="solado" type="text" id="solado" value="<? echo $linha[1]; ?>" size="70"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="40">&nbsp;</td>
...
<?
//QUERY PARA SELECIONAR TODOS DADOS NO BANCO DE DADOS 
$sql = "select * from solados order by solado";
