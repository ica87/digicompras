...
<p class="style2">Exclus&atilde;o de solados </p>
<p><a href="menu.php">Voltar</a></p>
<form action="excluir_solado.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do solado a ser exclu&iacute;do<br></td>
      <td width="25%"><select name="codigo" id="select4">
        <option value="null" selected>Selecione
        <?


    $sql = "select * from solados order by codigo";
