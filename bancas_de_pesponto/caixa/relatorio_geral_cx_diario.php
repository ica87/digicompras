...
?> </div></td>
                ...
                <tr>
                  <td><div align="center"><strong>Trabalhos</strong></div></td>
                  <td><div align="center">
                    <?
$sql = "select sum(valor_recebido) as total_trabalhos from cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Trabalhos'";
$resultado=mysql_query($sql, $conexao);
...
?>
                ...
                <tr>
                  <td><div align="center"><strong>C&oacute;pias</strong></div></td>
                  <td><div align="center">
                    <?
$sql = "select sum(valor_recebido) as total_copias from cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Cópias'";
$resultado=mysql_query($sql, $conexao);
...
?>
                ...
                <tr>
                  <td><div align="center"><strong>Internet</strong></div></td>
                  <td><div align="center">
                    <?
$sql = "select sum(valor_recebido) as total_internet from cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Internet'";
$resultado=mysql_query($sql, $conexao);
...
?>
                ...
                <tr>
                  <td><div align="center"><strong>Xerox</strong></div></td>
                  <td><div align="center">
                    <?
$sql = "select sum(valor_recebido) as total_xerox from cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Xerox'";
$resultado=mysql_query($sql, $conexao);
...
?>
                ...
                <tr>
                  <td><div align="center"><strong>Vendas</strong></div></td>
                  <td><div align="center">
                    <?
$sql = "select sum(valor_recebido) as total_vendas from cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Vendas'";
$resultado=mysql_query($sql, $conexao);
...
<table width="100%"  border="0">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td width="18%"><div align="center">Valor D&eacute;bito </div></td>
...
<table width="100%"  border="0">
  ...
  <?
$sql = "select * from cursos where dataalteracao = '$hoje' and status <> 'Ativo' order by codigo_aluno asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
$mensalidade = $linha[49];
$status_cancelado_finalizado = $linha[68];
...
?>
    ...
    <td><div align="center">
        <?
echo $status_cancelado_finalizado;
?>
    </div></td>
  </tr>
</table>
