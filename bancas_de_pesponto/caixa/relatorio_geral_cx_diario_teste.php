...
<?
$sql = "SELECT * FROM cx_entradas where datacadastro = '$hoje' and categoria_conta = 'Mensalidade' order by codigo desc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
        ...
        <table width="100%"  border="0">
          <tr>
            <td width="16%"><div align="center">C&oacute;digo do Aluno </div></td>
            <td width="15%"><div align="center">Mensalidade N&ordm; </div></td>
            <td width="19%"><div align="center">Valor Mensalidade </div></td>
            <td width="34%"><div align="center">Hist&oacute;rico</div></td>
            <td width="15%"><div align="center">Pr&oacute;x Mens. </div></td>
...
?>
            ...
            <td><div align="center"><? echo $num_mensalidade; ?> / <? echo $quant_parc; ?>
            </div></td>
            <td><div align="center">
              <?
echo $valor_recebido;
...
?>
            ...
            <td width="51%">
              <div align="center"><? echo "R$ ".$valor_total_mensalidades; ?></div></td>
          </tr>
          <? } ?>
          <tr>
