...
<form action="autalizar_material.php" method="post" name="form2">
...
$sql = "SELECT * FROM materiais where codigo = '$codigo'";
//EXECUTA O COMANDO ACIMA
$res = mysql_query($sql);
...
?></td>
        ...
        <tr>
          ...
          <td><input name="material" type="text" id="material" value="<? echo $linha[1]; ?>" size="70"></td>
          <td>&nbsp;</td>
        </tr>
        <tr>
          <td height="40">&nbsp;</td>
