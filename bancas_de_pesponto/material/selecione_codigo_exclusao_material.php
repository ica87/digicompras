...
<p class="style2">Exclus&atilde;o de materiais </p>
<p><a href="menu.php">Voltar</a></p>
<form action="excluir_material.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do material a ser exclu&iacute;do<br></td>
