...
<form action="grava_material.php" method="post" enctype="multipart/form-data" name="form1">
...
?>
    ...
    <tr>
      <td width="11%">&nbsp;</td>
      <td width="89%"><strong><font color="#0000FF" size="4">Tela de cadastro de material!</font></strong></td>
    </tr>
    <tr>
    ...
    <tr> 
      <td><font color="#0000FF"><strong>Material<font color="#0000FF">:</font></strong></font></td>
      <td><input name="material" type="text" id="material"></td>
    </tr>
    <tr> 
      <td>&nbsp;</td>
      <td><input type="submit" name="Submit" value="Gravar material">
...
<span class="style1">Material:</span> <? printf("$linha[1]<br>"); ?>
</td>
<?
if($reg==1){
echo "</tr><tr>";
