...
<p class="style2">Selecione o c&oacute;digo do material a ser alterado!</p>
<p><a href="menu.php">Voltar</a></p>
<form action="altera_material.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="35%">Selecione o c&oacute;digo. do material a ser editado<br></td>
      <td width="25%"><select name="codigo" id="select4">
        <option value="null" selected>Selecione
        <?


    $sql = "select * from materiais order by codigo";
