  ...
  <tr>
    <td width="43%" rowspan="2" valign="top"><form action="relatorio_periodico_sintetico.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="99%"  border="0">
        <tr>
          <td width="30%"><div align="center">Cliente</div></td>
          <td><strong>
    ...
    $sql = "select * from fichas group by nfantasia order by grupo asc";
...
?>
    ...
    <td><form action="relatorio_periodico_por_grupo_sintetico.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="99%"  border="0">
        ...
        <tr>
          <td width="27%"><div align="center">Cliente</div></td>
          <td colspan="2"><strong>
            <select name="nfantasia" id="nfantasia">
  ...
  <tr>
    ...
    <td width="47%"><form action="relatorio_por_grupo_e_periodo_analitico.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="99%"  border="0">
        ...
        <tr>
          <td width="167"><div align="center">Cliente</div></td>
          <td colspan="2"><strong>
            <select name="nfantasia" id="nfantasia">
              <option selected> <? echo "TODOS"; ?> </option>
              <?
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="43%" valign="top"><form action="relatorio_por_grupo_de_fichas_em_producao.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="98%"  border="0">
        ...
        <tr>
          <td width="31%"><div align="center">Cliente</div></td>
          <td><strong>
            <select name="nfantasia" id="nfantasia">
              <option selected> <? echo "TODOS"; ?> </option>
              <?
...
?>
    ...
    <td width="47%" valign="top"><form action="relatorio_de_fichas_em_producao_geral_sintetico.php" method="post" enctype="multipart/form-data" name="form1">
      <table width="98%"  border="0">
        ...
        <tr>
          <td width="32%"><div align="center">Cliente</div></td>
          <td><strong>
            <select name="nfantasia" id="nfantasia">
              <option selected> <? echo "TODOS"; ?> </option>
              <?
...
?>
  ...
  <tr>
    <td width="43%" valign="top"><form name="form2" method="post" action="relatorio_periodico_falta_metal.php">
      <table width="98%"  border="0">
        <tr>
          <td colspan="2"><div align="center"><strong>Relat&oacute;rio peri&oacute;dico  de Fichas sem metal</strong></div></td>
        </tr>
        <tr>
...
?>
            ...
            <input type="submit" name="Submit9" value="Gerar relat&oacute;rio"></td>
        </tr>
        <tr>
          <td width="31%">&nbsp;</td>
          <td width="69%">&nbsp;</td>
...
<form action="pesquisa_de_ficha.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td colspan="3"><div align="center"><strong>Pesquisa  de Fichas</strong></div></td>
    </tr>
    <tr>
