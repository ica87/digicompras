...
?>
    ...
    <td colspan="2"><div align="center"><strong>Pesquisa  de Fichas</strong></div></td>
...
?>
    ...
    <td width="11%"><div align="center">N&ordm; Plano</div></td>

    <td width="20%">N&ordm; da Ficha</td>
...
?>
        <input name="num_plano" type="text" id="num_plano" size="11" maxlength="11"> 
...
$sql = "select * from fichas where num_ficha = '$num_ficha' and num_plano = '$num_plano' order by num_ficha asc";
$res = mysql_query($sql);
$reg = 0;
while($linha=mysql_fetch_row($res)) {
...
$sql = "select * from historico_alteracoes_fichas where num_ficha = '$num_ficha' and num_plano = '$num_plano' order by codigo_ficha desc";
$res = mysql_query($sql);
$reg = 0;
while($linha=mysql_fetch_row($res)) {
