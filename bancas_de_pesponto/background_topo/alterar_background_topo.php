...
<p class="style2">&nbsp;</p>
<form action="atualizar_background_topo.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="27%">Escolha a imagem que deseja para o fundo do cabe&ccedil;alho </td>
