...
<p class="style1">
<form action="grava_background_topo.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="33%">Escolha a imagem que deseja para o fundo do cabe&ccedil;alho </td>
