...
<form name="form1" method="post" action="excluir_correspondente.php">
...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      ...
      <input name="email_estab_pertence" type="hidden" id="email_estab_pertence" value="<? echo $email_estab_pertence; ?>"></td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><strong><font color="#FF0000">Aten&ccedil;&atilde;o!!..Voc&ecirc; est&aacute; prestes a excluir o cadastro do correspondente abaixo!</font></strong></td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
    ...
    <tr>
      <td width="12%">Qual o motivo da exclus&atilde;o desse cadastro?</td>
      <td colspan="2"><textarea name="motivo_exclusao" cols="50" rows="6" id="motivo_exclusao"></textarea></td>
      <td width="25%">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr>
