...
<form action="modelos.php" method="post" enctype="multipart/form-data" name="form1">
  ...
  <table width="100%"  border="0">
    ...
    <tr>
      <td colspan="3" bgcolor="#CCCCCC"><div align="center"><strong>ATUALIZA&Ccedil;&Atilde;O DAS INFORMA&Ccedil;&Otilde;ES GERAIS DE MODELOS E FICHAS  INDIVIDUAL</strong></div></td>
    </tr>
    <tr>
