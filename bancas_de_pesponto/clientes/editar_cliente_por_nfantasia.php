...
?>
  ...
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr> 
      <td colspan="2"><strong><font color="#0000FF">C&oacute;digo que est&aacute; sendo editado: <? echo $codigo; ?>
...
?>
    ...
    <tr> 
      ...
      <td colspan="3" align="left" valign="top"> <textarea name="obs" cols="92" rows="3" wrap="PHYSICAL" id="obs"><? echo $linha[35]; ?></textarea>      </td>
      <td>&nbsp;</td>
    </tr>
    <tr> 
