...
?>
    ...
    <tr>
      ...
      <td width="77%"><strong><font color="#0000FF" size="4">O que deseja fazer com os funcion&aacute;rios?</font></strong></td>
...
?>
        ...
        <input type="submit" name="Submit2" value="Cadastrar Funcion&aacute;rio">
...
?>
        ...
        <input type="submit" name="Submit3" value="Editar Funcion&aacute;rio">
...
?>
        ...
        <input type="submit" name="button" id="button" value="Excluir Funcion&aacute;rio">
      </form></td>
