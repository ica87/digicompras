...
?>
      ...
      <td><strong><font color="#0000FF"><? echo date('d-m-Y'); ?></font></strong>
        ...
        <input name="areaproducao" type="hidden" id="areaproducao" value="N&atilde;o"></td>
    </tr>
...
?>
    ...
    <tr>
      <td>CBO</td>
      <td><input type="text" name="cbo" id="cbo"></td>
      <td>Se&ccedil;&atilde;o</td>
      <td><strong>
        <select name="secao" id="secao">
          <option selected><? echo "Selecione"; ?></option>
          <?
...
?>
    ...
    <tr>
      ...
      <td><select name="sindical" id="sindical">
        ...
        Valor
        <input type="text" name="valor_sindicato" id="valor_sindicato"></td>
...
?>
      <input type="submit" name="Submit" value="Cadastrar Funcion&aacute;rio"> 
