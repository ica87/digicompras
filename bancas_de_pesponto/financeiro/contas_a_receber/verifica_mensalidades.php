...
$sql = "SELECT * FROM cursos where codigo_aluno = '$codigo_aluno' order by codigo desc limit 1";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg_mensalidade++;
...
<table width="100%"  border="0">
        ...
        <tr>
<?
$sql = "SELECT * FROM contas_a_receber where codigo_aluno = '$codigo_aluno'";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
...
$sql = "SELECT * FROM contas_a_receber where codigo_aluno = '$codigo_aluno' and quitacao = 'Em Aberto'  order by codigo, vencto asc";
$res = mysql_query($sql);
while($linha=mysql_fetch_row($res)) {
$reg++;
...
?>
          ...
          <td width="10%"><div align="center"><? echo $num_mensalidade; ?> / <? echo $registros; ?></div></td>
...
$senha = $_SESSION['senha'];
?>
          <input name="codigo_contas_a_receber2" type="hidden" id="codigo_contas_a_receber2" value="<? echo $codigo; ?>">
          <input name="codigo_aluno2" type="hidden" id="codigo_aluno2" value="<? echo $codigo_aluno; ?>">
          <input name="nome_aluno2" type="hidden" id="nome_aluno2" value="<? echo $nome; ?>">
          <input name="datacadastro2" type="hidden" id="datacadastro2" value="<? echo date('d-m-Y'); ?>">
          <input name="horacadastro2" type="hidden" id="horacadastro2" value="<? echo date('H:i:s'); ?>">
          <input name="nome2" type="hidden" id="nome2" value="<? echo $nome; ?>">
          <input name="nome_resp2" type="hidden" id="nome_resp2" value="<? echo $nome_resp; ?>">
          <input name="cpf_resp2" type="hidden" id="cpf_resp2" value="<? echo $cpf_resp; ?>">
          <input name="curso2" type="hidden" id="curso2" value="<? echo $curso; ?>">
          <input name="modulos2" type="hidden" id="modulos2" value="<? echo $modulos; ?>">
          <input name="duracao2" type="hidden" id="duracao2" value="<? echo $duracao; ?>">
          <input name="mensalidade2" type="hidden" id="mensalidade2" value="<? echo $mensalidade; ?>">
          <input name="vencto2" type="hidden" id="vencto2" value="<? echo $vencto; ?>">
          <input name="quant_parc2" type="hidden" id="quant_parc2" value="<? echo $quant_parc; ?>">
          <input name="modo_pagto2" type="hidden" id="modo_pagto2" value="<? echo $modo_pagto; ?>">
          <input name="juros_diarios2" type="hidden" id="juros_diarios2" value="<? echo $juros_diarios; ?>">
          <input name="quitacao2" type="hidden" id="quitacao2" value="<? echo Pago; ?>">
          <input name="obs2" type="hidden" id="obs2" value="<? echo $obs; ?>">
          <input name="operador2" type="hidden" id="operador2" value="<? echo $nome_op; ?>">
          ...
          <input name="estabelecimento2" type="hidden" id="estabelecimento2" value="<? echo $estab_pertence_op; ?>">
          <input name="cidade_estabelecimento2" type="hidden" id="cidade_estabelecimento2" value="<? echo $cidade_estab_pertence_op; ?>">
          <input name="tel_estabelecimento2" type="hidden" id="tel_estabelecimento2" value="<? echo $tel_estab_pertence_op; ?>">
          <input name="email_estabelecimento2" type="hidden" id="email_estabelecimento2" value="<? echo $email_estab_pertence_op; ?>">
          <input name="categoria_conta2" type="hidden" id="categoria_conta2" value="<? echo "Mensalidade"; ?>">
          <input name="num_mensalidade2" type="hidden" id="num_mensalidade2" value="<? echo $num_mensalidade; ?>">
          <input name="historico2" type="hidden" id="historico2" value="<? echo " "; ?>">
          <?
if($quitacao=="Em Aberto"){
