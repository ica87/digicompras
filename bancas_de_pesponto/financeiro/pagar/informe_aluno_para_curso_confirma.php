...
<? } ?>
<form name="form1" method="post" action="informe_aluno_para_curso.php">
  <?
...
<table width="100%" border="0" cellspacing="4">
    <tr>
      <td colspan="4"><div align="center"><strong>CONFIRMA OS DADOS DO ALUNO?</strong></div></td>
    </tr>
    <tr>
      <td width="20%">&nbsp;</td>
      <td width="32%">C&oacute;digo</td>
      <td width="15%">        <input name="codigo" type="hidden" id="codigo4" value="<? echo $codigo; ?>"><? echo $codigo; ?></td><td width="33%">&nbsp;</td>
    </tr>
    <tr>
...
?>
      ...
      <td colspan="2"> <div align="left"><? echo $nome_resp; ?></div></td>
    </tr>
    <tr> 
      <td colspan="2">&nbsp;</td>
      <td>&nbsp;</td>
