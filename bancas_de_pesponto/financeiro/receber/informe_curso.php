...
?>
<? } ?>
<form name="form1" method="post" action="finaliza_matricula_curso.php">
...
<table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      <td width="15%">&nbsp;</td>
      <td width="37%">Informe o curso que o aluno deseja se matricular </td>
      <td width="15%"><select name="curso" id="select">
        <?


    $sql = "select * from produtos order by nome_curso asc";
    $result = mysql_query($sql);
    while($x=mysql_fetch_array($result)){
  echo "<option>".$x['nome_curso']."</option>";
    }
?>
      </select>
