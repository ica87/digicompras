...
<table width="100%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td width="17%">&nbsp;</td>
      <td width="27%"><strong><font color="#0000FF" size="4">O que deseja fazer no caixa <span class="style1"><? echo $nome_op; ?></span> ?</font></strong></td>
      <td width="26%">&nbsp;</td>
      <td width="30%">&nbsp;</td>
    </tr>
    <tr>
...
$sql = "SELECT * FROM cx_entradas where datacadastro = '$hoje' and historico = 'Abertura de Caixa'";
...
?>
      ...
      <td><form action="imprimir_caixa_por_data.php" method="post" name="form4" target="_blank">
        <?
