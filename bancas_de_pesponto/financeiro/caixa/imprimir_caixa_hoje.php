...
?>
  <table width="100%"  border="0">
        <tr>
          <td bgcolor="#CCCCCC"><div align="center" class="style14">            <span class="style13"><? echo $nome_op; ?></span><strong> verificando os lan&ccedil;amentos do caixa em <? echo $hoje; ?><BR>
	      </strong></div></td>
        </tr>
</table>
...
<table width="100%"  border="1">
  <tr>
    ...
    <div align="center" class="style2">Saldo 
      <span class="style14"><span class="style17">
      <?
