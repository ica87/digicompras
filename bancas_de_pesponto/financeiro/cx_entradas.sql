...
--
-- Estrutura da tabela `cx_entradas`
--

CREATE TABLE IF NOT EXISTS `cx_entradas` (
  `codigo` int(11) NOT NULL auto_increment,
  `codigo_contas_a_receber` varchar(50) NOT NULL,
  ...
  `cpf_resp` varchar(50) default NULL,
  `obs` text,
  ...
  `valor_recebido` varchar(50) default NULL,
  ...
  PRIMARY KEY  (`codigo`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5276 ;
