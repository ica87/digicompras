...
?>
    ...
    <tr>
      <td width="19%">&nbsp;</td>
      <td><strong><font color="#0000FF" size="4">Oque deseja fazer com os produtos?</font></strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td><form name="form2" method="post" action="escolha_de_categoria.php">
        <input type="submit" name="Submit2" value="Inserir produto ">
      </form></td>
    </tr>
    <tr>
      <td><div align="center"></div></td> 
      <td><form name="form3" method="post" action="../editar_produtos/menu_edit.php">
        <input type="submit" name="Submit3" value="Editar produto ">
      </form></td>
    </tr>
    <tr>
      <td><div align="center"></div></td> 
      <td><form name="form4" method="post" action="../excluir_produtos/selecione_codigo_exclusao.php">
