...
<table width="100%"  border="0">
  ...
  <tr>
    <td><form name="form1" method="post" action="mapa_de_todas_lojas_sintetico.php">
      <?
...
?>
  ...
  <tr>
    <td colspan="2"><div align="center" class="style10">Listando propostas da loja <? echo $estabelecimento_proposta; ?> do per&iacute;odo <? echo $mes_ano; ?></div></td>
  </tr>
  <tr>

    <td><form name="form4" method="post" action="relatorio_geral_por_loja.php">
      <?
...
?>
    ...
    <td width="51%"><form action="relatorio_geral_por_loja.php" method="post" name="form2">
      <div align="center">
        <?
...
$sql = "select * from propostas_veiculos where cpf = '..............' and estabelecimento_proposta = '$estabelecimento_proposta' and mes_ano = '$mes_ano' order by num_proposta desc";
...
$sql = "select * from propostas_veiculos where cpf = '$cpf' and estabelecimento_proposta = '$estabelecimento_proposta' and mes_ano = '$mes_ano' order by num_proposta desc";
...
<table width="100%"  border="0">
  ...
  <tr bgcolor="#CCCCCC">
    ...
    <td width="14%"><div align="center"><font size="2"><strong>N&ordm; Proposta </strong></font></div></td>

    <td width="9%"><div align="center"><font size="2"><strong>Data</strong></font></div></td>

    <td width="8%"><div align="center"><font size="2"><strong>Hora</strong></font></div></td>
    <td width="19%"><div align="center"><font size="2"><strong>Status</strong></font></div></td>

    <td width="15%"><div align="center"><font size="2"><strong>Loja</strong></font></div></td>

    <td width="10%"><div align="center"><font size="2"><strong>Operador</strong></font></div></td>

    <td width="9%"><div align="center"><font size="2"><strong>Nome</strong></font></div></td>
  ...
  <tr valign="middle">
    ...
    <td><div align="center"><font size="2"><? echo $horaproposta; ?></font></div></td>
    <td>
...
$sql = "select * from propostas_veiculos where estabelecimento_proposta = '$estabelecimento_proposta' and mes_ano = '$mes_ano' order by num_proposta desc";
...
$sql = "select * from propostas_veiculos where nome like '$nome%' and estabelecimento_proposta = '$estabelecimento_proposta' and mes_ano = '$mes_ano' order by num_proposta desc";
...
?>
  ...
  <tr bgcolor="#CCCCCC">
    <td width="14%"><div align="center"><font size="2"><strong>N&ordm; Proposta </strong></font></div></td>
    <td width="9%"><div align="center"><font size="2"><strong>Data</strong></font></div></td>
    <td width="8%"><div align="center"><strong><font size="2">Hora</font></strong></div></td>
    <td width="19%"><div align="center"><font size="2"><strong>Status</strong></font></div></td>
    <td width="15%"><div align="center"><font size="2"><strong>Loja</strong></font></div></td>
    <td width="10%"><div align="center"><font size="2"><strong>Operador</strong></font></div></td>
    <td width="9%"><div align="center"><font size="2"><strong>Nome</strong></font></div></td>
...
<div align="center"> <font size="1"> <? echo $status; ?>
              <input name="num_proposta" type="hidden" id="num_proposta" value="<? echo $num_proposta; ?>">
</font></div>
    </form></td>
    <td><div align="center"><font size="1"><? echo $estabelecimento_proposta; ?></font></div></td>
...
?>
  ...
  <table width="200%"  border="0">
    ...
    <tr bgcolor="#CCCCCC">
      ...
      <td width="32%"><div align="center" class="style4">Observa&ccedil;&otilde;es</div></td>
    </tr>
    <?
