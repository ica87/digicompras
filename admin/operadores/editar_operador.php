...
<table width="100%" border="0" cellspacing="4">
    <tr>
      <td>&nbsp;</td>
      <td><strong><font color="#0000FF">Esse operador trabalha conosco desde </font></strong></td>
...
$operador_alterou2 = $linha[33];
$cel_operador_alterou2 = $linha[34];
$email_operador_alterou2 = $linha[35];
$estabelecimento_alterou2 = $linha[36];
$cidade_estabelecimento_alterou2 = $linha[37];
$tel_estabelecimento_alterou2 = $linha[38];
$email_estabelecimento_alterou2 = $linha[39];
$dataalteracao2 = $linha[31];
$horaalteracao2 = $linha[32];
$estab_pertence_op = $linha[44];
$cidade_estab_pertence_op = $linha[45];
$tel_estab_pertence_op = $linha[46];
$email_estab_pertence_op = $linha[47];
...
?>
  ...
  <table width="100%" border="0" cellspacing="4">
    <tr>
      ...
      <font color="#0000FF"><? echo $operador_alterou; ?> </font></strong> </td>
    ...
    <tr>
      <td width="18%" valign="top" bgcolor="#CCCCCC"><strong><font color="#0000FF"> </font>Estabelecimento:</strong> <br>
          <strong><font color="#0000FF"><? echo $estab_pertence_op; ?> </font></strong> </td>
      ...
      <td valign="top" bgcolor="#CCCCCC"><strong><font color="#000000">E-Mail do estabelecimento: </font><font color="#0000FF"><br>
              <? echo $email_estab_pertence_op; ?> </font><font color="#ff0000"> </font></strong></td>
    ...
    <tr>
      ...
      <td valign="top" bgcolor="#CCCCCC"><strong>Hora que foi efetuada a altera&ccedil;&atilde;o <br>
...
$operador_alterou_op = $linha[1];
$cel_operador_alterou_op = $linha[19];
$email_operador_alterou_op = $linha[20];
$estabelecimento_alterou_op = $linha[44];
$cidade_estabelecimento_alterou_op = $linha[45];
$tel_estabelecimento_alterou_op = $linha[46];
$email_estabelecimento_alterou_op = $linha[47];
...
?>
  <table width="100%" border="0" cellspacing="4">
    ...
    <tr>
      ...
      </strong><strong><font color="#0000FF"><? echo $operador_alterou_op; ?> </font></strong><strong><font color="#0000FF"> </font></strong></td>
      <td width="35%"><strong><font color="#0000FF"> </font></strong><strong><font color="#000000">E-Mail do operador: </font><font color="#0000FF"><br>
