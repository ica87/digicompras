...
$sql = "SELECT * FROM operadores_ec where nome = '$nome'";
$res = mysql_query($sql);
$reg = 0;
echo "<tr>";
while($linha=mysql_fetch_row($res)) {
...
?>
  ...
  <table width="100%" border="0" cellspacing="4">
    <tr>
      ...
      <font color="#0000FF"><? echo $operador_alterou2; ?> </font></strong> </td>
      <td width="35%" valign="top" bgcolor="#CCCCCC"><strong><font color="#ff0000"> </font></strong><strong><font color="#000000">E-Mail do operador: </font><font color="#0000FF"><br>
              <? echo $email_operador_alterou2; ?> </font><font color="#ff0000"> </font></strong></td>
      <td width="20%" valign="top" bgcolor="#CCCCCC"><strong>Celular:<font color="#0000FF"><br>
              <? echo $cel_operador_alterou2; ?> </font><font color="#ff0000"> </font></strong></td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
