...
<p class="style2">Edi&ccedil;&atilde;o de modos de pagto </p>
<p><a href="menu.php">Voltar</a></p>
<form action="modo_pagto.php" method="post" enctype="multipart/form-data" name="form1">
  <table width="100%"  border="0">
    <tr>
      <td width="45%">Selecione o c&oacute;digo. do modo de pagto a ser editado<br></td>
