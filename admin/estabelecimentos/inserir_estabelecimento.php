...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      <td>&nbsp;</td>
      <td colspan="3"><strong><font size="4">Cadastro 
        de estabelecimentos!. </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>Data Cadastro </td>
      <td><strong><? echo date('d-m-Y'); ?></strong> 
        <input name="datacadastro" type="hidden" id="datacadastro2" value="<? echo date('d-m-Y'); ?>">        <input name="horacadastro" type="hidden" id="horacadastro2" value="<? echo date('H:i:s'); ?>">      </td>
...
?>
        ...
        </font>Atividade<font color="#FF0000">
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td><input name="aliquota" type="hidden" id="aliquota" value="5">      </td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
