...
<table width="100%" border="0" cellspacing="4">
    <tr> 
      ...
      <input name="aliquota" type="hidden" id="aliquota" value="<? echo $aliquota; ?>">
      <input name="usuaraio" type="hidden" id="categoria3" value="<? echo $usuario; ?>">
      <input name="senha" type="hidden" id="categoria4" value="<? echo $senha; ?>">
      <input name="status" type="hidden" id="categoria5" value="<? echo $status; ?>">
      <input name="foto" type="hidden" id="categoria6" value="<? echo $foto; ?>"></td>
      <td width="1%">&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
