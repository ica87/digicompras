...
<html>
<head>
<title>ALTERA&Ccedil;&Atilde;O DO CADASTRO DE EEMPRESA CONVENIADA</title>
...
<form name="form1" method="post" action="grava_editar.php">
  <table width="100%" border="0" cellspacing="4">
    <tr>
      <td>&nbsp;</td>
      <td colspan="3"><strong><font color="#0000FF" size="4">Tela de altera&ccedil;&atilde;o do cadastro de empresa conveniada!. </font></strong></td>
      <td>&nbsp;</td>
    </tr>
    <tr>
      <td>&nbsp;</td>
      <td>&nbsp;</td>
      <td>Status</td>
      <td><select name="status" id="select2">
    ...
    <tr>
      ...
      <td><select name="operador_atende" id="select6">
...
$senha = $_SESSION['senha'];
?>
          <input type="submit" name="Submit" value="Alterar dados da Empresa">
